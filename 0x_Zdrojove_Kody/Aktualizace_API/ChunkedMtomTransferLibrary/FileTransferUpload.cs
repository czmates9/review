	...
	public class FileTransferUpload : FileTransferBase
	{
		...
		protected override void OnDoWork(DoWorkEventArgs e)
		{
			...
			using(FileStream fs = new FileStream(this.LocalFilePath, FileMode.Open, FileAccess.Read))
			{
				...
				do
				{
					...
					try
					{
						...
						this.WebService.AppendChunk(this.TerminalID, this.LocalFileName, Buffer, this.Offset);
			...
			if(this.IncludeHashVerification)
			{
				...
				this.RemoteFileHash = this.WebService.CheckFileHash(this.TerminalID, this.LocalFileName);
