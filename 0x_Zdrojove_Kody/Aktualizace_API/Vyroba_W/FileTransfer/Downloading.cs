...
namespace Fask.Vyroba_W.FileTransfer
{
    public class Downloading
    {
        ...
        /// <returns></returns>
        /// <remarks>!!!Downloads file to fileciselnik.tmp. It is on to application level to handle this.tmp file correctly!!!</remarks>
        ...
        public static bool DownloadFileFromServer(string fileciselnik, bool silent, bool overwrite)
        {
            ...
            try
            {
                ...
                if (Program.mainApp != null)
                    Program.mainApp.UpdateStatusBarInfo(String.Format("Aktualizace:Zacatek dokončování"));
            ...
            finally
            {
                ...
                if (Program.mainApp != null)
                    Program.mainApp.UpdateStatusBarInfo(String.Format("Aktualizace:Konec dokončování"));
            }
            #endregion
        }
