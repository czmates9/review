            ...
            set
            {
                ...
                switch (_serverAccessCertificateTrust)
                {
                    case Globals.ServerAccessCertificatesTrustType.TrustAll:
                        System.Net.ServicePointManager.CertificatePolicy = new Fask.Aktualizace_API.ServerAccess.CertificatesPolicy.TrustAllCertificatePolicy();
                        break;
                    case Globals.ServerAccessCertificatesTrustType.TrustQuery:
                        System.Net.ServicePointManager.CertificatePolicy = new Fask.Aktualizace_API.ServerAccess.CertificatesPolicy.QueryTrustCertificatePolicy();
                        break;
