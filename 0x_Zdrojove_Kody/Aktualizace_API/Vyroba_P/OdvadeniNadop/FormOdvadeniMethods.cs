...
namespace Fask.Aktualizace_API.OdvadeniNadop
{
    public partial class FormOdvadeni
    {
        ...
        public void PerformOK()
        {
            ...
            try
            {
                Fask.SQLiteDBs.DataSets.Vyroba.ProductionDataTable pdt = Fask.Aktualizace_API.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__InternalState_PRD.GetDataByUserIDMachineIDNULL_Production(idpracovnik.id);
                Fask.SQLiteDBs.DataSets.Vyroba.ProductionDataTable pdtAll = Fask.Aktualizace_API.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__InternalState_PRD.GetDataByUserIDMachineID_Production(idpracovnik.id, idmachine.id);
                ...
                try
                {
                    ...
                    WebServiceVyroba.VyrobaDataSet dsW = Fask.Aktualizace_API.Forms.FormMain.Instance_FormMain.globalObject.CustomvyrobaServis.Production_OpenedCorrection2(idpracovnik.id, string.Empty);
                    WebServiceVyroba.VyrobaDataSet dsWAll = Fask.Aktualizace_API.Forms.FormMain.Instance_FormMain.globalObject.CustomvyrobaServis.Production_OpenedCorrection2(idpracovnik.id, idmachine.id);
                ...
                { // je otevrena korekce ...
                        ...
                        )
                    {
                        ...
                        var correctionrow = Fask.Aktualizace_API.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Vyroba_PRD.GetDataByID_Corrects(prowsdesc.First().TIMECRID).First(); ;
            ...
            try
            {
                ...
                Fask.Aktualizace_API.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__InternalState_PRD.FillByUserIDMachineID_Production(dsV.Production, idpracovnik.id, idmachine.id);
                ...
                try
                {
                    ...
                    dsVweb = Fask.Aktualizace_API.Forms.FormMain.Instance_FormMain.globalObject.CustomvyrobaServis.Production_OpenedProduction2(idpracovnik.id, idmachine.id);
            ...
            try
            {
                ...
                else if (drSouheh == DialogResult.Yes)
                {
                    while (true)
                    {
                        Fask.Aktualizace_API.OdvadeniNadop.FormInputKodWithVPHListWithVPHList fkod = new Fask.Aktualizace_API.OdvadeniNadop.FormInputKodWithVPHListWithVPHList();
        ...
        public void PerformZahajeniPrestavky()
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    Fask.Aktualizace_API.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__InternalState_PRD.FillByUserIDMachineIDNULL_Production(dsV.Production, idpracovnik.id);
                    Logging.ExceptionHandler2.Handle(Logging.LogLevel.Debug, "nacteni dat z webu, timeout je: " + Fask.Aktualizace_API.Forms.FormMain.Instance_FormMain.globalObject.CustomvyrobaServis.Timeout);
                    ...
                    WebServiceVyroba.VyrobaDataSet dsVWeb = Fask.Aktualizace_API.Forms.FormMain.Instance_FormMain.globalObject.CustomvyrobaServis.Production_OpenedCorrection2(idpracovnik.id, string.Empty); //korekce mimo vyrobu ...
            ...
            // Zahájení korekce přestávka            
                ...
                crrdt = Fask.Aktualizace_API.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Vyroba_PRD.GetDataByID_Corrects(Settings.PrestavkaID);
