...
namespace JR.Utils.GUI.Forms
{
     ...
     * Usage examples:
     * 
     *  FlexibleFlexibleMessageBox.Show("Just a text");
     * 
     *  FlexibleFlexibleMessageBox.Show("A text", 
     *                          "A caption"); 
     *  
     *  FlexibleFlexibleMessageBox.Show("Some text with a link: www.google.com", 
     *                          "Some caption",
     *                          MessageBoxButtons.AbortRetryIgnore, 
     *                          MessageBoxIcon.Information,
     *                          MessageBoxDefaultButton.Button2);
     *  
     *  var dialogResult = FlexibleFlexibleMessageBox.Show("Do you know the answer to life the universe and everything?", 
     *                                             "One short question",
    ...
    */
    public class FlexibleMessageBox
    {
        ...
        /// </summary>
        public static double MAX_HEIGHT_FACTOR = 0.7;
        ...
        {
            return FlexibleMessageBoxForm.Show(null, text, string.Empty, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button1, null);
        }
        ...
        {
            return FlexibleMessageBoxForm.Show(owner, text, string.Empty, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button1, null);
        }
        ...
        {
            return FlexibleMessageBoxForm.Show(null, text, caption, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button1, null);
        }
        ...
        {
            return FlexibleMessageBoxForm.Show(owner, text, caption, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button1, null);
        }
        ...
        {
            return FlexibleMessageBoxForm.Show(null, text, caption, buttons, MessageBoxIcon.None, MessageBoxDefaultButton.Button1, null);
        }
        ...
        {
            return FlexibleMessageBoxForm.Show(owner, text, caption, buttons, MessageBoxIcon.None, MessageBoxDefaultButton.Button1, null);
        }
        ...
        {
            return FlexibleMessageBoxForm.Show(null, text, caption, buttons, icon, MessageBoxDefaultButton.Button1, null);
        }
        ...
        {
            return FlexibleMessageBoxForm.Show(owner, text, caption, buttons, icon, MessageBoxDefaultButton.Button1, null);
        }
        ...
        {
            return FlexibleMessageBoxForm.Show(null, text, caption, buttons, icon, defaultButton, null);
        }
        ...
        {
            return FlexibleMessageBoxForm.Show(owner, text, caption, buttons, icon, defaultButton, null);
        }
        ...
        /// <param name="buttons">The buttons.</param>
        /// <param name="icon">The icon.</param>
        /// <param name="defaultButton">The BackColor.</param>
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton, Color color)
        {
            return FlexibleMessageBoxForm.Show(null, text, caption, buttons, icon, defaultButton, color);
        }
        ...
        /// <param name="defaultButton">The BackColor.</param>
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton, Color color)
        {
            return FlexibleMessageBoxForm.Show(owner, text, caption, buttons, icon, defaultButton, color);
        }
        ...
        /// <param name="defaultButton">The default button.</param>
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton, Color? color, string button1Text, string button2Text)
        {
            return FlexibleMessageBoxForm.Show(owner, text, caption, buttons, icon, defaultButton, color,  button1Text,  button2Text);
        }
        ...
        class FlexibleMessageBoxForm : Form
        {
            ...
            //    this.button1.Size = new System.Drawing.Size(buttonswidth, 24);
            ...
            //    // změna textu společně s richTextBoxMessage.Text
            ...
            //    this.richTextBoxMessage.Size = new System.Drawing.Size(200, 60);
            //    //this.richTextBoxMessage.MaximumSize = new Size(
            //    this.richTextBoxMessage.MaximumSize = new Size(Convert.ToInt32(SystemInformation.WorkingArea.Width * FlexibleMessageBoxForm.GetCorrectedWorkingAreaFactor(MAX_WIDTH_FACTOR)), 59);
            ...
            //    //this.richTextBoxMessage.VerticalScroll.LargeChange = this.VerticalScroll.Maximum * 26;
            ...
            //    this.button2.Size = new System.Drawing.Size(buttonswidth, 24);
            ...
            //    this.button3.Size = new System.Drawing.Size(buttonswidth, 24);
            ...
            private void InitializeComponent()
            {
                ...
                this.richTextBoxMessage.Name = "richTextBoxMessage";
                this.richTextBoxMessage.ReadOnly = true;
                this.richTextBoxMessage.Size = new System.Drawing.Size(196, 34);
                this.richTextBoxMessage.TabIndex = 0;
                this.richTextBoxMessage.Text = "<Message>";
                // 
                // panel1
            ...
            private static readonly String[] BUTTON_TEXTS_CZECH = { "OK", "Zrušit", "Ano", "Ne", "Zrušit", "Opakovat", "Ignorovat" };
            ...
            private FlexibleMessageBoxForm()
            {
                ...
                this._cultureType = getCultureType();
            }
            ...
            /// <summary>
            /// Gets the button text for the current language (czech, german, defaul: eng)
            /// </summary>
            ...
            private string GetButtonText(BUTTON_TEXT buttonTextIndex)
            {
                switch (_cultureType)
                {
                    case (int)Cultures.CZECH:
                        return BUTTON_TEXTS_CZECH[Convert.ToInt32(buttonTextIndex)];
                    case (int)Cultures.GERMAN:
                        return BUTTON_TEXTS_GERMAN[Convert.ToInt32(buttonTextIndex)];
                    default:
                        return BUTTON_TEXTS_ENGLISH[Convert.ToInt32(buttonTextIndex)];
                }
            }
            ...
            private int getCultureType()
            {
                if(CultureInfo.InstalledUICulture.TwoLetterISOLanguageName.Contains("cs"))
                {
                    return (int)Cultures.CZECH;
                }
                if(CultureInfo.InstalledUICulture.TwoLetterISOLanguageName.Contains("de"))
                {
                    return (int)Cultures.GERMAN;
                }

                return (int)Cultures.ENG;
            ...
            private static void SetDialogStartPosition(FlexibleMessageBoxForm flexibleMessageBoxForm, IWin32Window owner)
            {
                ...
                if (owner == null)
                {
                    var screen = Screen.FromPoint(Settings.ApplicationPosition);
                    ...
                    //flexibleMessageBoxForm.StartPosition = FormStartPosition.Manual;
                    //flexibleMessageBoxForm.TopMost = true;
                    flexibleMessageBoxForm.StartPosition = FormStartPosition.CenterParent;
            ...
            private static void SetDialogSizes(FlexibleMessageBoxForm flexibleMessageBoxForm, string text)
            {
                ...
                // test
                //flexibleMessageBoxForm.FormBorderStyle = System.Windows.Forms.FormBorderStyle.None;
                ...
                flexibleMessageBoxForm.Size = new Size(Convert.ToInt32(SystemInformation.WorkingArea.Width * FlexibleMessageBoxForm.GetCorrectedWorkingAreaFactor(MAX_WIDTH_FACTOR)),
                                                              Convert.ToInt32(SystemInformation.WorkingArea.Height * FlexibleMessageBoxForm.GetCorrectedWorkingAreaFactor(MAX_HEIGHT_FACTOR)));
                flexibleMessageBoxForm.MinimumSize = new Size(Convert.ToInt32(SystemInformation.WorkingArea.Width * FlexibleMessageBoxForm.GetCorrectedWorkingAreaFactor(MAX_WIDTH_FACTOR)),
                                                              Convert.ToInt32(SystemInformation.WorkingArea.Height * FlexibleMessageBoxForm.GetCorrectedWorkingAreaFactor(MAX_HEIGHT_FACTOR)));
            ...
            /// <param name="defaultButton">The default button.</param>
            /// <returns>The dialog result.</returns>
            public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton, Color? color, string button1Text = null, string button2Text = null)
            {
                ...
                #region MaR 21.2.2024

                if(MessageBoxButtons.YesNo == buttons)
                {
                    if (!string.IsNullOrEmpty(button1Text))
                        flexibleMessageBoxForm.button2.Text = button1Text;

                    if (!string.IsNullOrEmpty(button2Text))
                        flexibleMessageBoxForm.button3.Text = button2Text;
                }
                ...
                if (color.HasValue)
                {
                    flexibleMessageBoxForm.panel1.BackColor = color.Value;
                    flexibleMessageBoxForm.richTextBoxMessage.BackColor = color.Value;
                    flexibleMessageBoxForm.BackColor = color.Value;
                }
                //Set the font for all controls
                flexibleMessageBoxForm.Font = FONT;
                flexibleMessageBoxForm.richTextBoxMessage.Font = FONT;
                //string result = "SystemInformation.WorkingArea.Width/SystemInformation.WorkingArea.Height: " + SystemInformation.WorkingArea.Width + "/" + SystemInformation.WorkingArea.Height + "\n";
                //result += "flexibleMessageBoxForm.Size pred zmenou velikosti: " + flexibleMessageBoxForm.Size.ToString() + "\n";

                //result += "Richtextboxmessage pred zmenou velikosti: " + flexibleMessageBoxForm.richTextBoxMessage.Size.ToString() + "\n" +
                //    "panel1: " + flexibleMessageBoxForm.panel1.Size.ToString() + "\n";

                //result += "SystemInformation.WorkingArea.Width * CorrectedWorkingAreaFactor/SystemInformation.WorkingArea.Height * CorrectedWorkingAreaFactor: " + Convert.ToInt32(SystemInformation.WorkingArea.Width * FlexibleMessageBoxForm.GetCorrectedWorkingAreaFactor(MAX_WIDTH_FACTOR)) + "/" + Convert.ToInt32(SystemInformation.WorkingArea.Height * FlexibleMessageBoxForm.GetCorrectedWorkingAreaFactor(MAX_HEIGHT_FACTOR)) + "\n";
                ...
                //result += "flexibleMessageBoxForm.Size po zmene velikosti: " + flexibleMessageBoxForm.Size.ToString() + "\n";
                //result += "Richtextboxmessage po zmene velikosti: " + flexibleMessageBoxForm.richTextBoxMessage.Size.ToString() + "\n" +
                //    "panel1: " + flexibleMessageBoxForm.panel1.Size.ToString();
                // skrytí názvu programu
                //flexibleMessageBoxForm.FormBorderStyle = System.Windows.Forms.FormBorderStyle.None;
                //Fask.Logging.Log.Write(result);
