...
namespace Fask.Aktualizace_API.Forms
{
    public partial class FormPrehledFiltr : Form
    {
        ...
        public Aktualizace_API.WebServiceVyroba.FiltersHistory filter;
        ...
        public FormPrehledFiltr()
        {
            ...
            filter = new Fask.Aktualizace_API.WebServiceVyroba.FiltersHistory();
       ...
       private void ReadFromSQL()         
        {
            try
            {
                var x = Fask.Aktualizace_API.Forms.FormMain.Instance_FormMain.globalObject.vyrobaServis.Production_Filter(filter);
        ...
        private void Write(Fask.Aktualizace_API.WebServiceVyroba.VyrobaDataSet_StatistikaOdvadeni.FASK_FilterRow fdt) 
        {
            //fdt.Firstname == null 
