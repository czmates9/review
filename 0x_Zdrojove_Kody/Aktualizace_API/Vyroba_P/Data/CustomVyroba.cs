...
namespace Fask.Aktualizace_API.WebServiceVyroba
{
    public class CustomVyroba : _WebRefernces_Globals.WebServiceVyrobaSession
    {
        ...
        //    return vds;
        //}
        public Fask.Aktualizace_API.WebServiceVyroba.VyrobaDataSet Production_OpenedCorrection2(string userID, string MachineID)
        {
            string data = Production_OpenedCorrection_Json(userID, MachineID);
            Fask.Aktualizace_API.WebServiceVyroba.VyrobaDataSet vds = Newtonsoft.Json.JsonConvert.DeserializeObject<Fask.Aktualizace_API.WebServiceVyroba.VyrobaDataSet>(data);

            return vds;
        }

        public Fask.Aktualizace_API.WebServiceVyroba.VyrobaDataSet Production_OpenedProduction2(string userID, string MachineID)
        {
