   ...
   public class Comunication
    {
        ...
        internal static bool Communicate(REST_Type _Type, out IRestResponse response, string Param, string JSON_Message = "", string volajici = "")
        {
            try
            {
                ...
                Fask.RestSharp.API.Communication_4_7 com ;
                    ...
                    Config_trida.Config_ds.WEBAPI[0].Adresa, //   "192.168.1.121:8080", // 192.168.1.69/MST_Win_Kom_Server_7_Dasenka 
                    Config_trida.Config_ds.WEBAPI[0].Autorizace_DoAPI, //"MDox",
                    Config_trida.Config_ds.WEBAPI[0].AliasDB, // "api",
                    Config_trida.Config_ds.WEBAPI[0].isHTTPS, // false,
                    Config_trida.Config_ds.WEBAPI[0].API_TimeOut, //10000
                    "69",
                    "SledovaniStroju_Service"
                    );
