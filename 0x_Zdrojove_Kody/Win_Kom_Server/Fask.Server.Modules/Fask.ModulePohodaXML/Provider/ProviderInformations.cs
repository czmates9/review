...
namespace Fask.SQL
        ...
        Fask.Server.Interfaces.Informations.IInformations2_FEFOFIFO
    {
        public float? MnozstviNaSklade_Itemnumber_Location(string ItemNumber, string Location)
        {
            ...
            OleDbConnection xconnPOHODA = null;
            try
            {
                //Globals.LoadConfiguration();
                CommandType commandType = (CommandType)Enum.Parse(typeof(CommandType), Globals_V1.Konfigurace.Informations[0].MnozstviNaSklade_I_L_CommandType);
                string mnozstvinasklade_proc2 = Globals_V1.Konfigurace.Informations[0].MnozstviNaSklade2;
                string mnozstvinasklade_proc2_paramName1 = Globals_V1.Konfigurace.Informations[0].MnozstviNaSklade2_paramName1;
                string mnozstvinasklade_proc2_paramName2 = Globals_V1.Konfigurace.Informations[0].MnozstviNaSklade2_paramName2;


                xconnPOHODA = new OleDbConnection(Globals_V1.Konfigurace.ConnectionStrings[0].PohodaDB);
                string dbname = xconnPOHODA.Database;
                string mnozstvinasklade_proc2_paramName3 = Globals_V1.Konfigurace.Informations[0].MnozstviNaSklade2_paramName3;
                ...
                if (commandType == CommandType.StoredProcedure)
                {
                    ...
                    xcomm.Parameters.Add((new SqlParameter(mnozstvinasklade_proc2_paramName3, dbname)));
                }
