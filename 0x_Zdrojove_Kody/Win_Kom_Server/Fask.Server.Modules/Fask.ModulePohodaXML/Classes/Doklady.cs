    ...
    public class Doklad
    {
        ...
        public Doklad(Fask.Rady.DS_Rady.FASK_RADYRow Row)
        {
            if (Row != null)
            {
				...
				this.rada_Text = Row.IsRada_NazevNull() ? string.Empty : Row.Rada_Nazev.Trim();
				...
				this.Rada_Prefix = Row.IsRada_PrefixNull() ? string.Empty : Row.Rada_Prefix.Trim();
