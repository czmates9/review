...
namespace Fask.Module.Ingres.SAD.Database
{
    public class Tisk_FASK_FORMULARE
    {
        ...
        private static void InitializeCommandInsert_FASK_FORMULARE(IngresCommand command)
        {
            command.CommandText =
        ...
        private static void InitializeCommandUpdate_FASK_FORMULARE(IngresCommand command)
        {
            command.CommandText =
        ...
        private static void InitializeCommandDelete_FASK_FORMULARE(IngresCommand command)
        {
        ...
        private static void InitializeCommandSelect_FASK_FORMULARE(IngresCommand command)
        {
