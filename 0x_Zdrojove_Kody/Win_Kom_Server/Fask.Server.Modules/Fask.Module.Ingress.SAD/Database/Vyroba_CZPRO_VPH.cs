...
namespace Fask.Module.Ingres.SAD.Database
{
    public class Vyroba_CZPRO_VPH
    {
        ...
        private static void InitializeCommandInsert_CZPRO_VPH(IngresCommand command)
        {
            command.CommandText =
        ...
        private static void InitializeCommandUpdate_CZPRO_VPH(IngresCommand command)
        {
            command.CommandText =
        ...
        private static void InitializeCommandDelete_CZPRO_VPH(IngresCommand command)
        {
        ...
        private static void InitializeCommandSelect_CZPRO_VPH(IngresCommand command)
        {
            ...
            try
            {
                ...
                using (conn = new IngresConnection(CS))
                {
                    ...
                    using (var commandInsert = conn.CreateCommand())
                    {
                        ...
                        commandInsert.Parameters.Add(new IngresParameter()
