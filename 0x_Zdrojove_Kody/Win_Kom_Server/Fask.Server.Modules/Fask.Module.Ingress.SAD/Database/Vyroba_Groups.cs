...
namespace Fask.Module.Ingres.SAD.Database
{
    public class Vyroba_Groups
    {
        ...
        private static void InitializeCommandInsert_Groups(IngresCommand command)
        {
            command.CommandText =
        ...
        private static void InitializeCommandUpdate_Groups(IngresCommand command)
        {
        ...
        private static void InitializeCommandDelete_Groups(IngresCommand command)
        {
        ...
        private static void InitializeCommandSelect_Groups(IngresCommand command)
        {
