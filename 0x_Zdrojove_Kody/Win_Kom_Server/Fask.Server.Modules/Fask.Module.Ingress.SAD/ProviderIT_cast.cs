        ...
        Fask.Interfaces.IT_cast.IIT_cast_Production_Archivace
    {
        public int ArchivaceProcedura(DateTime? OD, DateTime? DO)
        {
            ...
            try
            {
                ...
                command = new IngresCommand("FASK_Events_ArchivaceZaznamu", conn);
                ...
                IngresParameter pocetPresunutychParam = new IngresParameter("@PocetPresunutych", SqlDbType.Int);
        ...
        public int Archivace_Fask_Event_id(int id)
        {
            ...
            {
                conn = new IngresConnection(Globals.Konfigurace.ConnectionString[0].FASKDB);
                command = new IngresCommand("FASK_Events_ArchivaceZaznamu_id", conn);
                command.CommandType = CommandType.StoredProcedure;
        ...
        public int Production_ArchivaceProcedura(DateTime? OD, DateTime? DO)
        {
            ...
            {
                conn = new IngresConnection(Globals.Konfigurace.ConnectionString[0].FASKDB);
                command = new IngresCommand("Production_ArchivaceZaznamu", conn);
                command.CommandType = CommandType.StoredProcedure;
        ...
        public int Production_ArchivaceProcedura_guid(Guid guid)
        {
            ...
            {
                conn = new IngresConnection(Globals.Konfigurace.ConnectionString[0].FASKDB);
                command = new IngresCommand("Production_ArchivaceZaznamu_guid", conn);
                command.CommandType = CommandType.StoredProcedure;
