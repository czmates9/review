...
namespace Fask.Module.Ingres.SAD.Classes
{
    public class Lokace
    {
		...
		public void ProcessPrijem(LokacePohyb record, IngresCommand command, IngresConnection connection, IngresTransaction transaction, IngresDataAdapter adapter)
		{
		...
		/// <param name="Transaction">Transakce.</param>
		/// <param name="Adapter">Adapter.</param>
		public void ProcessVydej(LokacePohyb record, IngresCommand Command, IngresConnection Connection, IngresTransaction Transaction, IngresDataAdapter Adapter)
		{
			if (record == null || Adapter == null || Command == null || Connection == null || Transaction == null)
