...
namespace Fask.ModuleSql
{
    ...
    public partial class Provider : Fask.Server.Interfaces.Ciselniky.ICiselniky
    {
        ...
        public Fask.Interfaces.DataSets.Zbozi KatalogZbozi(Fask.Server.Interfaces.Classes.Terminal terminal, Fask.Server.Interfaces.Classes.Sklad sklad, ref Fask.Server.Interfaces.Classes.StatusObject so)
        {
            ...
            conn = new System.Data.SqlClient.SqlConnection(Globals.Konfigurace.ConnectionString[0].FASKDB);
            //25.8.2025 MaR zakomentoval, bralo se vse zprava
        ...
        public Fask.DataSets.TypDokladu KatalogTypDokladu(Fask.Server.Interfaces.Classes.Terminal terminal, Fask.Server.Interfaces.Classes.Sklad sklad)
        {
            ...
            #region 25.8.2025 MaR zakomentoval, bralo konvenci zprava
            //string select = "SELECT * FROM " + TABLE_CZMST092 +
            //    " Where SKL_ID like '" + sklad.ID + "%'"; 
            #endregion
        ...
        public Fask.Server.Interfaces.Classes.StatusInfo KatalogZboziExport(Fask.Server.Interfaces.Classes.Terminal terminal, Fask.Server.Interfaces.Classes.Sklad sklad, ref Fask.Server.Interfaces.Classes.StatusObject so)
        {
            ...
            try
            {
                ...
                ((IDataParameter)adpacommand.Parameters["@ExportTypFilter"]).Value = Globals.Konfigurace.ExportZasoby[0].ExportTypFilter;
                ((IDataParameter)adpacommand.Parameters["@ExportSkladFilter"]).Value = Globals.Konfigurace.ExportZasoby[0].ExportSkladFilter;
                ((IDataParameter)adpacommand.Parameters["@ExportovatPouzeAktivniPolozky"]).Value = Globals.Konfigurace.ExportZasoby[0].ExportovatPouzeAktivniPolozky;
                ((IDataParameter)adpacommand.Parameters["@EXZas_DotahovatAlternativniDodavatele"]).Value = Globals.Konfigurace.ExportZasoby[0].EXZas_DotahovatAlternativniDodavatele;
                ((IDataParameter)adpacommand.Parameters["@EvidenceSarzi"]).Value = Globals.Konfigurace.Sdilene[0].EvidenceSarzi;
                ((IDataParameter)adpacommand.Parameters["@EvidenceVyrobnichCisel"]).Value = Globals.Konfigurace.Sdilene[0].EvidenceVyrobnichCisel;
        ...
        public Fask.Server.Interfaces.Classes.StatusInfo KatalogPracovniciExport(Fask.Server.Interfaces.Classes.Terminal terminal, ref Fask.Server.Interfaces.Classes.StatusObject so)
        {
            ...
            try
            {
                ...
                adpaconnection = new System.Data.SqlClient.SqlConnection(Globals.Konfigurace.ConnectionString[0].FASKDB);
                System.Data.SqlClient.SqlCommand adpacommand = new System.Data.SqlClient.SqlCommand("FASK_proc_EXPORT_SQL_FASK_Pracovnici");
                adpacommand.CommandType = CommandType.StoredProcedure;
        ...
        public StatusInfo KatalogTypDokladuExport(Terminal terminal, Sklad sklad, ref StatusObject so)
        {
            ...
            try
            {
                ...
                adpaconnection = new System.Data.SqlClient.SqlConnection(Globals.Konfigurace.ConnectionString[0].FASKDB);
                System.Data.SqlClient.SqlCommand adpacommand = new System.Data.SqlClient.SqlCommand("FASK_proc_EXPORT_SQL_FASK_TypDokladu");
                adpacommand.CommandType = CommandType.StoredProcedure;
