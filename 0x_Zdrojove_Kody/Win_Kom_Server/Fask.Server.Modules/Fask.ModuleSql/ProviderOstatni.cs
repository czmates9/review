...
{
    public partial class Provider : Fask.Server.Interfaces.Ostatni.IOstatni
    {

        #region IOstatni Members
        ...
        public StatusInfo Ostatni_GenerateDavka(Objednavka objednavka, Sklad sklad)
        {
            ...
            if (objednavka.ID == "prelokovani")
            {
                ...
                string stav = Classes.Ostatni.Export_Prelokovani_SQL_Ostatni(objednavka, sklad);
