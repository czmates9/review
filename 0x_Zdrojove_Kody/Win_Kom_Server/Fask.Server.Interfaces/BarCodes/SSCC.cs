...
{
	/// <summary>
	/// Trida pro praci s SSCC kodem dle standardu GS1
	/// </summary>
    public class SSCC
    {
        ...
        /// <summary>
        /// Metoda pro naparsovani SSCC kodu z řetezce do objektu
        /// </summary>
        /// <param name="s"></param>
        /// <returns></returns>
		...
		/// <summary>
		/// Metoda pro vypočet kontrolnej čislice pro 19 znakovy SSCC
		/// </summary>
		/// <param name="s"></param>
		/// <returns></returns>
