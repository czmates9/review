<%@ Page Title="" Language="C#" MasterPageFile="~/MP_Main.Master" AutoEventWireup="true" CodeBehind="Konfigurace_ProviderSql.aspx.cs" Inherits="Fask.MST_W_Server.Konfigurace.Stranky.Konfigurace_ProviderSql" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link rel="stylesheet" href="../../Grafika/CSS/Konfigurace_ProviderSql.css" type="text/css">
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <nav class="col-sm-3" id="myScrollspy">
        <ul class="nav nav-pills nav-stacked">
            ...
            <li><a href="#section3">Inventura2</a></li>
            <li><a href="#section4">Prijem</a></li>
            <li><a href="#section5">Vydej</a></li>
            <li><a href="#section6">Prodej</a></li>
            <li><a href="#section7">Servis</a></li>
            <li><a href="#section8">Informations</a></li>
            <li><a href="#section9">LokMech</a></li>
        </ul>
    </nav>
    ...
    <div class="col-sm-9">
        ...
        <div id="section3">
            <h1>Inventura2</h1>
            <asp:Table ID="Inventura2" runat="server" class="Tabulka">
        ...
        <div id="section7">
            <h1>Servis</h1>
            <asp:Table ID="Servis" runat="server" class="Tabulka">
        ...
        <div id="section8">
            <h1>Informations</h1>
            <asp:Table ID="Informations" runat="server" class="Tabulka">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptyJS" runat="server">
    ...
    <script src="../../Grafika/JS/Konfigurace_ProviderSql.js" type="text/javascript"></script>
