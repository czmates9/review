<%@ Page Title="" Language="C#" MasterPageFile="~/MP_Main.Master" AutoEventWireup="true" CodeBehind="Konfigurace_ProviderABRA_SAB.aspx.cs" Inherits="Fask.MST_W_Server.Konfigurace.Stranky.Konfigurace_ProviderABRA_SAB" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link rel="stylesheet" href="../../Grafika/CSS/Konfigurace_ProviderABRA_SAB.css" type="text/css">
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <nav class="col-sm-3" id="myScrollspy">
        <ul class="nav nav-pills nav-stacked">
            ...
            <li><a href="#section2">Web API</a></li>
            <li><a href="#section3">ID Rady</a></li>
            <li><a href="#section4">ProcesniRizeni</a></li>
            <li><a href="#section5">Vydej</a></li>
            <li><a href="#section6">Inventura</a></li>
            <li><a href="#section7">Prijem</a></li>
            <li><a href="#section8">Prodej</a></li>
            <li><a href="#section9">ExportZasoby</a></li>
        </ul>
    </nav>
    ...
    <div class="col-sm-9">
        ...
        <div id="section2">
            <h1>Web API</h1>
            <asp:Table ID="WEBAPI" runat="server" class="Tabulka">
        ...
        <div id="section3">
            <h1>ID Rady</h1>
            <asp:Table ID="ID_Rady" runat="server" class="Tabulka">
        ...
        <div id="section4">
            <h1>Procesni Rizeni</h1>
            <asp:Table ID="ProcesniRizeni" runat="server" class="Tabulka">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptyJS" runat="server">
    ...
    <script src="../../Grafika/JS/Konfigurace_ProviderABRA_SAB.js" type="text/javascript"></script>
