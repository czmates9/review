...
{
    /// <summary>
	/// Služba přenosu dat LoginService
    /// </summary>
	[WebService(Namespace = "http://LoginService.fask.cz/", Description = "Služba přenosu dat LoginService")]
    ...
    public class LoginService : System.Web.Services.WebService
    {
		...
		[WebMethod(Description = "Metoda pro otestovaní vygenerovaní souboru pro uživatele")]
		...
		[WebMethod(Description = "Metoda pro nachystani souboru uživatele podle ID TErminalu")]
		...
		/// <returns></returns>
		[WebMethod(Description = "Metoda pro vypočet HASH")]
		...
		/// <returns>True-OK, False- chyba</returns>
		[WebMethod(Description = "Metoda pro online oveřeni uživatele")]
