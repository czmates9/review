...
namespace Fask.MST_W_Server.BL
{
    public class PrijemBL
    {
        ...
        public PrijemBL(Fask.Server.Interfaces.Prijem.IPrijem provider)
        {
		...
		/// <summary>
		/// Metoda která vratí jednu přijemku pro metodu která připravuje soubor pro terminal
		/// </summary>
		/// <param name="countentries">číslo dávky</param>
		/// <param name="idterminal">ID Terminalu</param>
		/// <returns>Dataset Prijem naplnení data příjemky</returns>
		...
		/// <param name="processState">přiznam co se ma stat: Zpracovat, Uvolnit</param>
		...
		/// </summary>
		/// <param name="ponumber">číslo objednavky</param>
		...
		/// <summary>
		/// Metoda která ukončí přijemku tym že na CZ_DOSLO natsaví ID TErminal + 100 
		/// </summary>
		/// <param name="idterminal">ID Terminalu</param>
		/// <param name="idCountEntries">číslo dávky</param>
		/// <param name="password">Heslo</param>
		/// <returns>StatusObject - Objekt který nese informace o stavu</returns>
		[Description("Metoda která ukončí přijemku tym že na CZ_DOSLO natsaví ID TErminal + 100 ")]
		...
		/// <summary>
		/// Metoda sloužíci pro vypočet položky zda se ma dát na Sklad, Exedici aleno rozdelit
		/// </summary>
		...
		[Description("Metoda sloužíci pro vypočet položky zda se ma dát na Sklad, Exedici aleno rozdelit")]
		...
		/// <summary>
		/// Metoda sloužíci pro Storno přijemky (Nastaví CZ_Doslo na 100)
		/// </summary>
		/// <param name="idterminal">ID Terminalu</param>
		/// <param name="idCountEntries">číslo dávky</param>
		/// <param name="password">Heslo</param>
		/// <returns>StatusObject - Objekt ktery nese informace o stavu</returns>
		[Description("Metoda sloužíci pro Storno přijemky (Nastaví CZ_Doslo na 100)")]
		...
		/// <summary>
		/// Metoda která vratí přijemky z předlohy podle ID Terminalu a Prefixu ID Skladu
		/// </summary>
		/// <param name="idterminal">ID Terminalu v CZ_Doslo</param>
		/// <param name="prefixskladu">ID Skladu SKL_ID like 'xxx%'</param>
		/// <returns>Dataset PrijemDavky najdenych přijemek</returns>
		[Description("Metoda která vratí přijemky z předlohy podle ID Terminalu a Prefixu ID Skladu")]
		...
		[Description("Metoda slouží pro nachystaní souboru pro terminál")]
		...
		/// <summary>
		/// Metoda slouží pro označení davku za uspešne staženou pro daný terminal
		/// </summary>
		/// <param name="countentries">číslo dávky</param>
		/// <param name="idterminal">ID Terminalu</param>
		/// <returns>True- označeno, False- chyba</returns>
		[Description("Metoda slouží pro označení davku za uspešne staženou pro daný terminal")]
		...
		/// <param name="processState">přiznam co se ma stat: Zpracovat, Uvolnit</param>
		/// <returns>StatusObject - Objektr který vraci informace o stavu</returns>
		[Description("Metoda sloužící pro rozbalení ZIP souboru, a vytažení dat z souboru do pameti. Nasledne zavolá metodu ProcessPrijemka která zpracuje data. ")]
		...
		[Description("Metoda která vrací Netypovy dataset podle dotazu v konfiguraci")]
		...
		/// <param name="orderid">ORD ID, ordinery, ID řadku??</param>
		/// <param name="serltnum">Seriove čislo/ šarže</param>
		/// <returns>Netypovy dataset podle dotazu v konfiguraci</returns>
		[Description("Metoda kter vraci netypovy dataset podle dotazu v konfiguraci")]
		...
		#region Generovani davky z terminalu pro Přijem
		...
		public StatusObject GenerateDavkaRequest(string ponumber, string skl_id)
		{
			...
			so.StatusText = "Příprava dávky dokladu '" + ponumber + "'";
			so.Write();
		...
		public int GenerateDavka(string ponumber, string skl_id)
		{
			...
			try
			{
				...
				if ((provider != null) && (provider is Fask.Server.Interfaces.Prijem.IPrijem))
				{
					...
					StatusInfo si = (provider as Fask.Server.Interfaces.Prijem.IPrijem).Prijem_GenerateDavka(objednavka, sklad);
					return si.ID;
				}
		...
		/// <param name="skl_id">ID SKladu</param>
		/// <returns>StatusObjekt - informace o zpracování</returns>
		[Description("Metoda slouzi terminalu ke smazani statusu a znovu generovani prikazu(davky)")]
		...
		/// <summary>
		/// Metoda pravdepodobne pro praci s Lok. Mechanizmem, přidávani položky
		/// </summary>
		/// <param name="countentries">číslo dávky</param>
		/// <param name="idterminal">ID Terminalu</param>
		/// <param name="prijemRows">řádky pro přidání</param>
		/// <returns>StatusObject - Objekt ktery nese informace</returns>
		[Description("Metoda pravdepodobne pro praci s Lok. Mechanizmem, přidávani položky")]
		...
		/// <param name="prijemRows">řádky pro přidání</param>
		/// <returns>StatusObject - Objekt ktery nese informace</returns>
		[Description("Metoda pravdepodobne pro praci s Lok. Mechanizmem, mazani položky")]
		...
		/// <param name="countentries">číslo dávky</param>
		/// <param name="idterminal">ID Terminalu</param>
		/// <param name="prijemRows">reference na řádky pro přidání</param>
		/// <returns>StatusObject - Objekt ktery nese informace</returns>
		[Description("Metoda pravdepodobne pro praci s Lok. Mechanizmem, neco s množstvím")]
		...
		/// <param name="itemnmbr">ID položky</param>
		/// <param name="skl_id">ID Skladu</param>
		/// <param name="oldSerltnum">staré seriove čislo/šarže</param>
		/// <returns>Nove seriove čislo/šarže</returns>
		[Description("Metoda pro zavolaní procedury Prijem_GenerateSerltnum_Action")]
		...
		/// </summary>
		/// <param name="serltnum">seriove číslo/ šarže</param>
		/// <param name="itemnmbr">ID položky</param>
		...
		[Description("Metoda pro Online overeni lokace")]
		...
		/// <summary>
		/// Metoda která vraci nerealizovane přijemky, dle čarovych kodu.
		/// </summary>
		/// <param name="terminalid">ID terminalu</param>
		/// <param name="skladid">ID Skladu</param>
		/// <param name="itemtype">Typ položky</param>
		/// <param name="ListCarKod">List čarovych kodu</param>
		/// <returns>Naplneni dataset Obecne</returns>
		[Description("Metoda která vraci nerealizovane přijemky, dle čarovych kodu.")]
		...
		/// <summary>
		/// Metoda která zavolá proceduru  Prijem_GetDoporuceneLokace_Action a vrati doporučene lokace
		/// </summary>
		/// <param name="itemnmbr">ID položky</param>
		/// <param name="skl_id">ID Skladu</param>
		/// <param name="serltnum">seriove čislo/ šarže</param>
		/// <returns>Naplneni dataset Obecne</returns>
		[Description("Metoda která zavolá proceduru Prijem_GetDoporuceneLokace_Action a vrati doporučene lokace")]
		...
		/// </summary>
		/// <returns>Naplneni dataset Obecne</returns>
		[Description("Metoda která zavola proceduru Prijem_GetNezrealizovanePrijemky_Action a vrati nerealizovane prjemky")]
