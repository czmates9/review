...
namespace Fask.Console.Interfaces.Classes
{
    public class PohybyISListFiltr : FilterBase
    {
        ...
        public Fask.Console.Interfaces.Classes.TimeFilters.TimeVariants? DatumVytvoreni_TimeVariant { get; set; }

        public DateTime? DatumUlozeni_OD { get; set; }
        public DateTime? DatumUlozeni_DO { get; set; }
        public Fask.Console.Interfaces.Classes.TimeFilters.TimeVariants? DatumUlozeni_TimeVariant { get; set; }
