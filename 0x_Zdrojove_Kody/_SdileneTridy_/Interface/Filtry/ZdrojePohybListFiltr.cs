...
namespace Fask.Interfaces.Filtry
{
    public class ZdrojePohybListFiltr
    {
        ...
        public FASK.Logins.DataSets.Pristupy.FASK_LoginsRow rowUzivatel { get; set; }
        public string UzivatelID { get; set; }

        // vybrany zaznam z comboboxu nebo vyplneny popis
        public Fask.Interfaces.DataSets.Servis.CZMST_Servis_ZdrojRow rowZdrojID { get; set; }
        public string ZdrojID { get; set; }

        // vybrany zaznam z comboboxu nebo vyplneny popis
        public Fask.Interfaces.DataSets.Servis.CZMST_Servis_StavRow rowStavID { get; set; }
        public string StavID { get; set; }

        // vybrany zaznam z comboboxu nebo vyplneny popis
        public Fask.Interfaces.DataSets.Servis.CZMST_Servis_CinnostRow rowCinnostID { get; set; }
