...
namespace Fask.Interfaces.Filtry
{
    public class StavSkladuListFiltr
    {
        ...
        // vybrany zaznam z comboboxu nebo vyplneny popis
        public Fask.Interfaces.DataSets.StavSkladu.get_os_msRow rowMaterialLOCNCODE { get; set; }
        public string MaterialLocncode { get; set; }

        // vybrany zaznam z comboboxu nebo vyplneny popis
        public Fask.Interfaces.DataSets.StavSkladu.CZMST093Row rowMaterialSKLID { get; set; }
