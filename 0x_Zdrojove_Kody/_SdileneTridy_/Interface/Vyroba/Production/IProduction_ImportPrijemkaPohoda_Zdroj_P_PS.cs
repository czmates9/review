...
{
    public interface IProduction_ImportPrijemkaPohoda_Zdroj_P_PS : IProduction
    {
        /// <summary>
        ...
        string Production_ImportPrijemkaPohoda_Zdroj_P_PS(int countEntries,string SKL_ID, string userID, string Vydejka);
    }
}
