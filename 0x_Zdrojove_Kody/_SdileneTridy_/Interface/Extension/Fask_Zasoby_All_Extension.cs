...
namespace Fask.Extension
{
    public static class Fask_Zasoby_All_Extension
    {
        ...
        public static Fask.WEBAPI.API_BusinessObjects.FASK_ZASOBY_ALL DataSetToBO(this Fask.Interfaces.DataSets.Zbozi.FASK_ZASOBY_ALL_KONZOLADataTable dt)
        {

            try
            {
                Fask.WEBAPI.API_BusinessObjects.FASK_ZASOBY_ALL listObjektu_FZ = new Fask.WEBAPI.API_BusinessObjects.FASK_ZASOBY_ALL(); //vytvoreni tabulky
                List<Fask.WEBAPI.API_BusinessObjects.FASK_ZASOBY_ALL_row> rowList = new List<Fask.WEBAPI.API_BusinessObjects.FASK_ZASOBY_ALL_row>(); //vytvoreni docasne tabulky

                foreach (var item in dt)
                {
                    Fask.WEBAPI.API_BusinessObjects.FASK_ZASOBY_ALL_row row = new Fask.WEBAPI.API_BusinessObjects.FASK_ZASOBY_ALL_row(); //docasny radek
                    ...
                    row.DEX_ROW_ID_PARAMETRY = item.IsDEX_ROW_ID_PARAMETRYNull() ? null : (int?)item.DEX_ROW_ID_PARAMETRY;
        ...
        public static Fask.Interfaces.DataSets.Zbozi.FASK_ZASOBY_ALL_KONZOLADataTable BOToDataSet(this Fask.WEBAPI.API_BusinessObjects.FASK_ZASOBY_ALL bo)
        {
            ...
            try
            {
                ...
                foreach (var item in bo.rows.ToList<Fask.WEBAPI.API_BusinessObjects.FASK_ZASOBY_ALL_row>())
                {
                    var x = dt.NewFASK_ZASOBY_ALL_KONZOLARow();
                    ...
                    //x.VPrFVTS = item.VPrFVTS.HasValue ? item.VPrFVTS.Value : false;   //implementovat vsude..

                    //x.VPrFPTS = item.VPrFPTS; item.VPrFPTS.HasValue? item.VPrFPTS.Value: false;   //implementovat vsude..

                    //x.VPrFDTS = item.VPrFDTS; item.VPrFDTS.HasValue? item.VPrFDTS.Value: false;   //implementovat vsude..

                    //x.VPrFITS = item.VPrFITS; item.VPrFITS.HasValue? item.VPrFITS.Value: false;   //implementovat vsude..

                    //x.VPrFXTS = item.VPrFXTS; item.VPrFXTS.HasValue? item.VPrFXTS.Value: false;   //implementovat vsude.. 
                    #endregion
                    ...
                    x.VPrFPTS =  item.VPrFPTS.HasValue? item.VPrFPTS.Value: false;   //implementovat vsude..

                    x.VPrFDTS =  item.VPrFDTS.HasValue? item.VPrFDTS.Value: false;   //implementovat vsude..

                    x.VPrFITS =  item.VPrFITS.HasValue? item.VPrFITS.Value: false;   //implementovat vsude..

                    x.VPrFXTS =  item.VPrFXTS.HasValue? item.VPrFXTS.Value: false;   //implementovat vsude.. 
                    #endregion
                    ...
                    if (item.DEX_ROW_ID_PARAMETRY.HasValue)
                    {
                        x.DEX_ROW_ID_PARAMETRY = item.DEX_ROW_ID_PARAMETRY.Value;
                    }
                    else
                    {
                        x.SetDEX_ROW_ID_PARAMETRYNull();
                    }
                    ...
                    dt.AddFASK_ZASOBY_ALL_KONZOLARow(x);
