...
namespace Fask.Extension
{
    public static class Fask_Zasoby_Extension
    {
        ...
        public static Fask.WEBAPI.API_BusinessObjects.FASK_ZASOBY DataSetToBO(this Fask.Interfaces.DataSets.Zbozi.FASK_ZASOBY_KONZOLADataTable dt)
        {
            try
            {
                Fask.WEBAPI.API_BusinessObjects.FASK_ZASOBY listObjektu_FZ = new Fask.WEBAPI.API_BusinessObjects.FASK_ZASOBY(); //vytvoreni tabulky
                List<Fask.WEBAPI.API_BusinessObjects.FASK_ZASOBY_row> rowList = new List<Fask.WEBAPI.API_BusinessObjects.FASK_ZASOBY_row>(); //vytvoreni docasne tabulky

                foreach (var item in dt)
                {
                    Fask.WEBAPI.API_BusinessObjects.FASK_ZASOBY_row row = new Fask.WEBAPI.API_BusinessObjects.FASK_ZASOBY_row(); //docasny radek
        ...
        public static Fask.Interfaces.DataSets.Zbozi.FASK_ZASOBY_KONZOLADataTable BOToDataSet(this Fask.WEBAPI.API_BusinessObjects.FASK_ZASOBY bo)
        {

            try
            {
                Fask.Interfaces.DataSets.Zbozi.FASK_ZASOBY_KONZOLADataTable dt = new Fask.Interfaces.DataSets.Zbozi.FASK_ZASOBY_KONZOLADataTable();

                foreach (var item in bo.rows.ToList<Fask.WEBAPI.API_BusinessObjects.FASK_ZASOBY_row>())
                {
                    var x = dt.NewFASK_ZASOBY_KONZOLARow();
                    ...
                    dt.AddFASK_ZASOBY_KONZOLARow(x);
