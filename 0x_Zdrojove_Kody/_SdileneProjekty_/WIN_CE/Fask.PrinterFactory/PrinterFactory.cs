...
namespace Fask.PrinterFactory
{
    ...
    public sealed class PrinterFactory
    {
                            ...
                            case "Prijem":
                                switch (sablona.Name)
                                {
                                    ...
                                    case "Nasnimane":
                                        ...
                                        break;
									case "Paletovylistek":
										templates.Add(PrinterModules.PrijemPaletovylistek, new ModuleToPrint(PrinterModules.PrijemPaletovylistek, pType, template));
										break;
									case "PaletaHlavicka":
										templates.Add(PrinterModules.PrijemPaletaHlavicka, new ModuleToPrint(PrinterModules.PrijemPaletaHlavicka, pType, template));
										break;
									case "PaletaRadek":
										templates.Add(PrinterModules.PrijemPaletaRadek, new ModuleToPrint(PrinterModules.PrijemPaletaRadek, pType, template));
										break;
									case "PaletaPaticka":
										templates.Add(PrinterModules.PrijemPaletaPaticka, new ModuleToPrint(PrinterModules.PrijemPaletaPaticka, pType, template));
										break;
                                    default:
                                        break;
                                }
                    ...
                    try
                    {
                        ...
                        switch (m2p.PrinterModule)
                        {
                            ...
                            case PrinterModules.PrijemNasnimane:
                                ...
                                break;
							case PrinterModules.PrijemPaletaHlavicka:
								xE = modulesNode.SelectSingleNode("Prijem").SelectSingleNode("PaletaHlavicka") as XmlElement;
								break;
							case PrinterModules.PrijemPaletaRadek:
								xE = modulesNode.SelectSingleNode("Prijem").SelectSingleNode("PaletaRadek") as XmlElement;
								break;
							case PrinterModules.PrijemPaletaPaticka:
								xE = modulesNode.SelectSingleNode("Prijem").SelectSingleNode("PaletaPaticka") as XmlElement;
								break;
                            ...
                            case PrinterModules.VydejPaletovylistek:
                                ...
                                break;
							case PrinterModules.VydejPaletaHlavicka:
								xE = modulesNode.SelectSingleNode("Vydej").SelectSingleNode("PaletaHlavicka") as XmlElement;
								break;
							case PrinterModules.VydejPaletaRadek:
								xE = modulesNode.SelectSingleNode("Vydej").SelectSingleNode("PaletaRadek") as XmlElement;
								break;
							case PrinterModules.VydejPaletaPaticka:
								xE = modulesNode.SelectSingleNode("Vydej").SelectSingleNode("PaletaPaticka") as XmlElement;
								break;
        ...
        public bool Print(Dictionary<string, string> dataHeader, List<Dictionary<string, string>> dataRowList, Dictionary<string, string> dataFooter, PrinterModules printerModule, int pocet)
        {
			...
			if (printerModule == PrinterModules.PrijemPaletaHlavicka
				|| printerModule == PrinterModules.PrijemPaletaPaticka
				|| printerModule == PrinterModules.PrijemPaletaRadek)
			{
				m2pH = templates[PrinterModules.PrijemPaletaHlavicka];
				m2pR = templates[PrinterModules.PrijemPaletaRadek];
				m2pF = templates[PrinterModules.PrijemPaletaPaticka];
			}
