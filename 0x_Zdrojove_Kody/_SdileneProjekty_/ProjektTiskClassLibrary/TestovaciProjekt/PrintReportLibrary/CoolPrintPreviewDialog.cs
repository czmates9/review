...
namespace PrintReportLibrary
{
    ...
    public partial class CoolPrintPreviewDialog : Form
    {
        ...
        private void pDFToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            //if (!InitPrint())
            //{
            //    throw new Exception("Err init report");
            //}

            if (!RenderReport("PDF", "PDF"))
            {
                throw new Exception("Err render report");
            }

            foreach (var item in m_streams)
            {
                this.SaveToFile(item, "PDF", null);
            }
        }
        ...
        private void pNGToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            foreach (var item in m_streams)
            {
                this.SaveToFile(item, "PNG", count.ToString());
                count++;
        ...
        {
            if ((PrintReportLibrary.Projekt.DDD == this._projekt) || (PrintReportLibrary.Projekt.MST == this._projekt))
            {
                this.ShowIcon = false;
                this.WindowState = FormWindowState.Maximized;
            }
