...
namespace Zuby.ADGV
{
    ...
    public class AdvancedDataGridView : DataGridView
    {
        ...
        /// <summary>
        /// aktualizace sloupcu po loadu ...
        /// Tato metodaa je POVINNA
        /// </summary>
        public void UpdateColumnHeaderCellsByDatasource()
        {
            ...
            foreach (DataGridViewColumn col in columns)
            {
                if (col != null)
                {
                    this.OnMyPropertyChanged(new System.Windows.Forms.DataGridViewColumnEventArgs(col));
                }
            }
        }

        internal void OnMyPropertyChanged(DataGridViewColumnEventArgs e)
        {
            e.Column.SortMode = DataGridViewColumnSortMode.Programmatic;
            ColumnHeaderCell cell = new ColumnHeaderCell(e.Column.HeaderCell, FilterAndSortEnabled);
