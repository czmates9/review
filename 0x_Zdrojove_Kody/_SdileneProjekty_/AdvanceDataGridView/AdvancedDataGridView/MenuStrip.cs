...
namespace Zuby.ADGV
{
    ...
    internal partial class MenuStrip : ContextMenuStrip
    {
                ...
                : base()
        {
            ...
            //_textStrings.Add("SORTDATETIMEASC", "Seřadit od nejstarší po nejnovější");
            //_textStrings.Add("SORTDATETIMEDESC", "Seřadit od nejnovější po nejstarší");
            //_textStrings.Add("SORTBOOLASC", "Seřadit podle False/True");
            //_textStrings.Add("SORTBOOLDESC", "Seřadit podle True/False");
            //_textStrings.Add("SORTNUMASC", "Seřadit nemenší po největší");
            //_textStrings.Add("SORTNUMDESC", "Seřadit největší po nemenší");
            //_textStrings.Add("SORTTEXTASC", "Seřadit А do Z");
            //_textStrings.Add("SORTTEXTDESC", "Seřadit Z do A");
            //_textStrings.Add("ADDCUSTOMFILTER", "Přidejte vlastní filtr");
            //_textStrings.Add("CUSTOMFILTER", "Přidejte filtr");
            //_textStrings.Add("CLEARFILTER", "Smazat filtr");
            //_textStrings.Add("CLEARSORT", "Smazat řazení");
            //_textStrings.Add("BUTTONOK", "Filter");
            //_textStrings.Add("BUTTONCANCEL", "zrušit");
            //_textStrings.Add("NODESELECTALL", "(Vybrat vše)");
            //_textStrings.Add("NODESELECTEMPTY", "(medzera)");
            //_textStrings.Add("FILTERCHECKLISTDISABLED", "Seznam filtrů je zakázán");
            ...
            {
                customFilterLastFiltersListMenuItem.Text = Properties.Settings.Default.MenuStrip_CUSTOMFILTER ;
                sortASCMenuItem.Text = Properties.Settings.Default.MenuStrip_SORTDATETIMEASC ;
                sortDESCMenuItem.Text = Properties.Settings.Default.MenuStrip_SORTDATETIMEDESC ;
            ...
            {
                customFilterLastFiltersListMenuItem.Text = Properties.Settings.Default.MenuStrip_CUSTOMFILTER ;
                sortASCMenuItem.Text = Properties.Settings.Default.MenuStrip_SORTBOOLASC ;
                sortDESCMenuItem.Text = Properties.Settings.Default.MenuStrip_SORTBOOLDESC ;
            ...
            {
                customFilterLastFiltersListMenuItem.Text = Properties.Settings.Default.MenuStrip_CUSTOMFILTER ;
                sortASCMenuItem.Text = Properties.Settings.Default.MenuStrip_SORTNUMASC ;
                sortDESCMenuItem.Text = Properties.Settings.Default.MenuStrip_SORTNUMDESC ;
                sortASCMenuItem.Image = Properties.Resources.MenuStrip_OrderASCnum;
                sortDESCMenuItem.Image = Properties.Resources.MenuStrip_OrderDESCnum;
            }
            else
            {
                customFilterLastFiltersListMenuItem.Text = Properties.Settings.Default.MenuStrip_CUSTOMFILTER ;
                sortASCMenuItem.Text = Properties.Settings.Default.MenuStrip_SORTTEXTASC ;
                sortDESCMenuItem.Text = Properties.Settings.Default.MenuStrip_SORTTEXTDESC ;
        ...
        public void SetFilterChecklistEnabled(bool enabled)
        {
            ...
            if (!IsFilterChecklistEnabled)
            {
                ...
                TreeNodeItemSelector disablednode = TreeNodeItemSelector.CreateNode(Properties.Settings.Default.MenuStrip_FILTERCHECKLISTDISABLED  + "            ", null, CheckState.Checked, TreeNodeItemSelector.CustomNodeType.SelectAll);
                ...
                if (DataType == typeof(DateTime))
                {
                    foreach (TreeNodeItemSelector n in nodes)
                    {
                        if (n.Checked && (n.Nodes.AsParallel().Cast<TreeNodeItemSelector>().Where(sn => sn.CheckState != CheckState.Unchecked).Count() == 0))
                        {
                            ...
                            sb.Append("(Convert([{0}], 'System.String') LIKE '%" + filt_dt.ToShortDateString() + "%')" + appx);
                        }
        ...
        private void BuildNodes(IEnumerable<DataGridViewCell> vals)
        {
            ...
            {
                //add select all node
                TreeNodeItemSelector allnode = TreeNodeItemSelector.CreateNode(Properties.Settings.Default.MenuStrip_NODESELECTALL  + "            ", null, CheckState.Checked, TreeNodeItemSelector.CustomNodeType.SelectAll);
                allnode.NodeFont = new Font(checkList.Font, FontStyle.Bold);
                checkList.Nodes.Add(allnode);
                ...
                if (vals.Count() > 0)
                {
                    ...
                    {
                        TreeNodeItemSelector nullnode = TreeNodeItemSelector.CreateNode(Properties.Settings.Default.MenuStrip_NODESELECTEMPTY  + "               ", null, CheckState.Checked, TreeNodeItemSelector.CustomNodeType.SelectEmpty);
