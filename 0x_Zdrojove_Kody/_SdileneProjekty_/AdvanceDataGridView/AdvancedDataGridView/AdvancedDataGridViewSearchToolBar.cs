...
namespace Zuby.ADGV
{
    ...
    public partial class AdvancedDataGridViewSearchToolBar : ToolStrip
    {
        ...
        public AdvancedDataGridViewSearchToolBar()
        {
            ...
            //_textStrings.Add("LABELSEARCH", "Vyhledávání:");
            //_textStrings.Add("BUTTONFROMBEGINTOOLTIP", "Od začátku");
            //_textStrings.Add("BUTTONCASESENSITIVETOOLTIP", "Citlivost kazu");
            //_textStrings.Add("BUTTONSEARCHTOOLTIP", "Najdi další");
            //_textStrings.Add("BUTTONCLOSETOOLTIP", "Skrýt");
            //_textStrings.Add("BUTTONWHOLEWORDTOOLTIP", "Vyhledat pouze celé slovo");
            //_textStrings.Add("COMBOBOXCOLUMNSALL", "(Všechny sloupce)");
            //_textStrings.Add("TEXTBOXSEARCHTOOLTIP", "Hodnota pro vyhledávání");
            ...
            this.comboBox_columns.Items.AddRange(new object[] { Properties.Settings.Default.ToolBar_COMBOBOXCOLUMNSALL });
            this.button_close.ToolTipText = Properties.Settings.Default.ToolBar_BUTTONCLOSETOOLTIP ;
            this.label_search.Text = Properties.Settings.Default.ToolBar_LABELSEARCH ;
            this.textBox_search.ToolTipText = Properties.Settings.Default.ToolBar_TEXTBOXSEARCHTOOLTIP ;
            this.button_frombegin.ToolTipText = Properties.Settings.Default.ToolBar_BUTTONFROMBEGINTOOLTIP ;
            this.button_casesensitive.ToolTipText = Properties.Settings.Default.ToolBar_BUTTONCASESENSITIVETOOLTIP ;
            this.button_search.ToolTipText = Properties.Settings.Default.ToolBar_BUTTONSEARCHTOOLTIP ;
            this.button_wholeword.ToolTipText = Properties.Settings.Default.ToolBar_BUTTONWHOLEWORDTOOLTIP ;
        ...
        public void SetColumns(DataGridViewColumnCollection columns)
        {
            ...
            comboBox_columns.Items.AddRange(new object[] { Properties.Settings.Default.ToolBar_COMBOBOXCOLUMNSALL  });
