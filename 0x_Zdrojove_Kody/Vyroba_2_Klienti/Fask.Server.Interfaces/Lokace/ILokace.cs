...
namespace Fask.Server.Interfaces.Lokace
{
    ...
    public interface ILokace
    {
        ...
        /// <summary>
        /// Zobrazi mnozstvi materialu v jednotlivych regalech.
        /// </summary>
        ...
        /// <param name="skl_id">ID skladu.</param>
        /// <returns>Odpovidajici zaznamy.</returns>
        Fask.Server.Interfaces.DataSets.Location Lokace_GetMaterial(string itemnmbr, string serltnum, string locncode, string skl_id);
        /// <summary>
