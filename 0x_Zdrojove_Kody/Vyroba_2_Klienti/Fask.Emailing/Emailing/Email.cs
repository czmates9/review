...
namespace Fask.Emailing
{
    public static class Email
    {
        ...
        private static bool _sendErrorEmail = false;

        /// <summary>
        /// Odesilani chybovych hlaseni
        /// </summary>
        ...
        public static void LoadConfiguration(string FileName)
        {
            ...
            //_sendErrorEmail = Convert.ToBoolean(LoadElement(xmldoc, "/Emailing/SendErrorEmail"));
        ...
        {
            // kontrola, zdali se ma email odesilat
            if (!_sendErrorEmail)
                return;
            //Odeslani
        ...
        /// <summary>
        /// Nacteni konfigurace, vytvoreni emailove zpravy a odeslani emailu.
        /// </summary>
        /// <param name="Head">Hlavicka</param>
        /// <param name="Body">Telo</param>
