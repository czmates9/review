    ...
    public partial class FormOdvadeni
    {
            ...
            try
            {
                ...
                if (Settings.VyberZakazkyPoPrihlaseni)
                {
                    if (Globals.Zakazka == null)
                        dtvpp = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Vyroba_PRD.GetDataByBarcodeP_CZPRO_VPP(this.textBoxVyrobniOperace.Text);
                    else
                        dtvpp = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Vyroba_PRD.GetDataByBarcodePandSOPNUMBEandCountEntries_CZPRO_VPP(this.textBoxVyrobniOperace.Text, Globals.Zakazka.SOPNUMBE, Globals.Zakazka.CountEntries);
                ...
                Fask.SQLiteDBs.DataSets.Vyroba.CZPRO_VPHDataTable dtvph = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Vyroba_PRD.GetDataByCountEntriesSopnumbe_CZPRO_VPH(rowvpp.CountEntries, rowvpp.SOPNUMBE);
                ...
                Fask.SQLiteDBs.DataSets.Vyroba.ProductionDataTable dtL_LastProductionUserMachine = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__InternalState_PRD.GetDataByUserIDMachineID_Production(idpracovnik.id, idmachine.id);

                //Dohledani poctu odvedenych kusu z production tabulky k poslednimu datu modifikace zaznamu v tabulce VPP
                decimal? qtyodvedeno = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Production_PRD.QTY_Production(rowvpp.CountEntries, rowvpp.SOPNUMBE, rowvpp.ORD, rowvpp.ITEMNMBR, rowvpp.ITEMTYPE, rowvpp.QTYPACK, rowvpp.LSTMod, rowvpp.BarcodeP);
                ...
                try
                {
                    dsR_LastProductionUserMachine = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.vyrobaServis.ProductionLastAction(idpracovnik.id, idmachine.id, false, 1);
                }
                catch (Exception ews)
                {
                    ...
                    if (pRow.IsTIMECRIDNull())
                    {
                        ...
                        if (!(pRow.qty == 0 && !pRow.IsTIMESTOPNull()) || Settings.PovolitOdvadeniMnozstviNula)
                        {
                            ...
                            try
                            {
                                ...
                                Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Vyroba_PRD.Connection_Open();
                                int raff = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Vyroba_PRD.UpdateQtyCntOdvedenoLSTMod_CZPRO_VPP(pRow.qty, 1, pRow.dateeve, pRow.CountEntries, pRow.SOPNUMBE, pRow.ORD, pRow.ITEMNMBR, pRow.ITEMTYPE, pRow.QTYPACK, pRow.BarcodeP);
                                Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Vyroba_PRD.Connection_Close();
                            }
                            catch (Exception e)
                            {
                ...
                Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Production_PRD.Update_Production_Sources(psdt);
        ...
        private DateTime? UserLastAction()
        {
            ...
            try
            {
                ...
                Fask.SQLiteDBs.DataSets.Vyroba.ProductionDataTable dt_lst_LProduction = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Production_PRD.GetDataByUserID_Production(idpracovnik.id);
                ...
                try
                {
                    lastUserActionDateTimeServer = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.vyrobaServis.UserLastAction(idpracovnik.id);
                }
                catch (Exception ews)
                {
                    Fask.Logging.ExceptionHandler2.Handle(this.GetType().ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, ews);
        ...
        private bool CheckCorrectionsOpenedNoProduction()
        {
            try
            {
                ...
                Fask.SQLiteDBs.DataSets.Vyroba.ProductionDataTable dt_lst_LProduction = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Production_PRD.GetDataByUserIDMachineIDNULL_Production(idpracovnik.id);
                ...
                try
                {
                    ds_lst_RProduction = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.vyrobaServis.ProductionLastAction(idpracovnik.id, string.Empty, true, 1);
                ...
                else
                {
                    ...
                    {
                        Fask.SQLiteDBs.DataSets.Vyroba.CorrectsDataTable cdt = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Vyroba_PRD.GetDataByID_Corrects(existingProductionRow.TIMECRID);
            ...
            )
        {
           ...
           pocetOdvedeno = 0; //decimal pocetOdvedeno = 0;
            ...
            using (FormInputQuantity frmKod = new FormInputQuantity(rowvph, rowvpp))
                {
                if (Settings.Main_Mereni_Papouch)
                {
                    frmKod.mereniPapouch = true;
                }

                frmKod.Podbarveni = false;
                    ...
                    if (Settings.Main_Mereni_Papouch)
                    {
                        //productionRow.REZ_1 = frmKod.mereniPapouch1.ToString();
                        //productionRow.REZ_2 = frmKod.mereniPapouch2.ToString();
                        //productionRow.REZ_3 = frmKod.mereniPapouch3.ToString();
                        //productionRow.REZ_4 = frmKod.mereniPapouch4.ToString();
                        
                            productionRow.REZ_1 = frmKod.tB_Mer_1.Text;
                        productionRow.REZ_2 = frmKod.tB_Mer_2.Text;
                        productionRow.REZ_3 = frmKod.tB_Mer_3.Text;
                        productionRow.REZ_4 = frmKod.tB_Mer_4.Text;
                    }
            ...
            if (Settings.Production_Destination_SKLID_Enter)
            {
                ...
                using (Forms.FormInputKod fik = new Forms.FormInputKod())
                {
                    ...
                    //    )
                    //{
                    //    var listSklady = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Vyroba_PRD.GetDataBySklid_CZMST093(productionRow.SKL_ID);
                    ...
                    #region MaR novy 21.102024

                    if (Settings.rB_production_Destination_SKLID_value)
                    {
                    ...
                    else
                    {
                        ...
                        //if (!productionRow.IsSKL_IDNull() && !String.IsNullOrEmpty(productionRow.SKL_ID.Trim()))
                        //{ // zadani skladu z vybrane polozky ...
                        //  // TODO overeni???
                        //    fik.Kod = productionRow.SKL_ID;
                        //}
                        //else
                        //{
                        //    fik.Kod = string.Empty;
                    ...
                    while (true)
                    {
                        ...
                        if (listSklady.Count() == 0)
                        {
                            //if (DialogResult.Cancel == MessageBox.Show("Sklad '" + fik.Kod + "' neexistuje v číselníku skladů!", "Cílový sklad", MessageBoxButtons.RetryCancel, MessageBoxIcon.Asterisk, MessageBoxDefaultButton.Button1))
                            //    return DialogResult.Cancel;
                            CustomMessageBox.Show("Sklad '" + fik.Kod + "' neexistuje v číselníku skladů!", "Cílový sklad", 26);
            ...
            else
            {
                ...
                if (Settings.rB_production_Destination_SKLID_value)
                {
                    if (!string.IsNullOrEmpty(Settings.Production_Destination_SKLID))
                    {
                        ...
                        var listSklady = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Vyroba_PRD.GetDataByBarcode_CZMST093(Settings.Production_Destination_SKLID);
                        if (listSklady.Count() == 0)
                        {
                            //FlexibleMessageBox.Show("Sklad '" + Settings.Production_Destination_SKLID + "' neexistuje v číselníku skladů!", "Cílový sklad", MessageBoxButtons.OK, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1);

                            CustomMessageBox.Show("Sklad '" + Settings.Production_Destination_SKLID + "' neexistuje v číselníku skladů!", "Cílový sklad", 26);
                    ...
                    {
                        productionRow.SKL_ID = string.Empty;
                    }
                }
                else
                {
                    ...
                    //    var listSklady = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Vyroba_PRD.GetDataBySklid_CZMST093(productionRow.SKL_ID);
                    //    if (listSklady.Count() > 0)
                    //        productionRow.SKL_ID = listSklady.First().skl_carcode;
                    //}
                    //else
                    //{
                    //    productionRow.SKL_ID = string.Empty;
                    ...
                    { // zadani skladu z vybrane polozky ...
                      // TODO overeni???
                        ...
                        if (listSklady.Count() > 0)
                            ...
                            productionRow.SKL_ID = string.Empty;
                        //  productionRow.SKL_ID = productionRow.SKL_ID;
                    }
                    else
                    {
                        productionRow.SKL_ID = string.Empty;
            ...
            if (Settings.Production_Destination_LOCNCODE_Enter)
            {
                ...
                using (Forms.FormInputKod fik = new Forms.FormInputKod())
                {
                    ...
                    {
                        var listLokace = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Vyroba_PRD.GetDataBySklidLocncode_CZMST094(productionRow.SKL_ID, productionRow.LOCNCODE);
                    ...
                    while (true)
                    {
                        ...
                        var listLokace = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Vyroba_PRD.GetDataBySklidBarcode_CZMST094(productionRow.SKL_ID, fik.Kod);
                        if (listLokace.Count() == 0)
                        {
        ...
        private string NajdiSklad(string ITEMNMBR,string VNDITNUM)
        {
            try
            {
                Fask.SQLiteDBs.DataSets.Vyroba.FASK_CONS_095DataTable zboziDatatable = new Fask.SQLiteDBs.DataSets.Vyroba.FASK_CONS_095DataTable();
                Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Vyroba_PRD.SKL_ID_ITEMNMBR_CZMST_095(zboziDatatable, ITEMNMBR, VNDITNUM);

                if (zboziDatatable.Count > 0)
                {
                    return zboziDatatable.First().SKL_ID;
                }
                else
                return string.Empty;
            }
        ...
        private void ProductionRowFill(decimal? qtyodvedeno, Fask.SQLiteDBs.DataSets.Vyroba.CZPRO_VPPRow rowvpp, Fask.SQLiteDBs.DataSets.Vyroba.ProductionRow productionRow, decimal pocetOdvedeno)
        {
           ...
           // productionRow.SKL_ID = rowvpp.skl
            productionRow.UserID = idpracovnik.id;
            productionRow.TermID = Settings.TerminalID;

            //MaR 18.10.2024 dohledani skladu
            productionRow.SKL_ID = NajdiSklad(rowvpp.ITEMNMBR, rowvpp.VNDITNUM);
           // string cisloSklad = string.Empty;
        ...
        public void DeleteOperace()
        {
            ...
            try
            {
                Fask.SQLiteDBs.DataSets.Vyroba.ProductionDataTable dtL_LastProductionUserMachine = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Production_PRD.GetDataByUserIDMachineID_Production(idpracovnik.id, idmachine.id);
        ...
        private void DeletePriprava(bool? remote, DateTime? lLastTimeStateDateTime, Fask.SQLiteDBs.DataSets.Vyroba.ProductionRow PRow)
        {
            try
            {
                ...
                using (Odvadeni.FormHeslo frmHeslo = new Fask.Vyroba_P.Odvadeni.FormHeslo())
                {
                ...
                if (remote == false)
                {
                    ...
                    Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Production_PRD.FillByBarcodePUserIDdateeve_Production(Production, PRow.BarcodeP, idPracovnik.id, (DateTime)lLastTimeStateDateTime);
                    ...
                    Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Production_PRD.Insert_UserEvents(
                        idPracovnik.id,
                        idmachine.id,
                        DateTime.Now,
                ...
                else if (remote == true)
                {
                    ...
                    Fask.Vyroba_P.WebServiceVyroba.VyrobaDataSet ds = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.vyrobaServis.Production_OpenedProduction(idPracovnik.id, idmachine.id);
        ...
        private void DeleteOdvod(bool? remote, DateTime? lLastTimeStateDateTime, Fask.SQLiteDBs.DataSets.Vyroba.ProductionRow PRow)
        {
            try
            {
                ...
                if (remote == false)
                {
                    ...
                    //pta.FillByBarcodePUserIDdateeve(Production, cislooperace, idPracovnik.id, (DateTime)userLastAction);
                    Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Production_PRD.FillByBarcodePUserIDdateeve_Production(Production, PRow.BarcodeP, idPracovnikLocal.id, (DateTime)lLastTimeStateDateTime);
                ...
                {
                    Fask.Vyroba_P.WebServiceVyroba.VyrobaDataSet ds = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.vyrobaServis.Production_OpenedProduction(idPracovnikLocal.id, idmachine.id);
