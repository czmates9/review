...
namespace Fask.Vyroba_P.Odvadeni.Materialy
{
    public partial class FormMaterialVyberTP : Form
    {
        ...
        private void ScannerStart()
        {
            try
            {
                FormMain.Scanner.DataReady -= new Fask.Vyroba_P.Scanner.ScannerEventHandler(Scanner_DataReady_TP);
                FormMain.Scanner.DataReady += new Fask.Vyroba_P.Scanner.ScannerEventHandler(Scanner_DataReady_TP);
        ...
        private void ScannerEventHandlerMethod_TP(object sender, Fask.Vyroba_P.Scanner.ScannerEventArgs e)
        {
            try
            {
                ScannerStop();
        ...
        void Scanner_DataReady_TP(object sender, Fask.Vyroba_P.Scanner.ScannerEventArgs e)
        {
            try
            {
                this.BeginInvoke(new Fask.Vyroba_P.Scanner.ScannerEventHandler(ScannerEventHandlerMethod_TP), new object[] { sender, e });
