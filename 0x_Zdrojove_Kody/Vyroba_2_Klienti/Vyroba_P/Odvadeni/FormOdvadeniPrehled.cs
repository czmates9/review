...
namespace Fask.Vyroba_P
{
    public partial class FormOdvadeniPrehled : Form
    {
        ...
        public Vyroba_P.Odvadeni.FormOdvadeni.TIMESTATE _TimeStateActual =  Odvadeni.FormOdvadeni.TIMESTATE.Unknown;
        public Vyroba_P.Odvadeni.FormOdvadeni.TIMESTATE _TimeStateLast = Odvadeni.FormOdvadeni.TIMESTATE.Unknown;
        ...
        private Color GetColorForTimeState(Vyroba_P.Odvadeni.FormOdvadeni.TIMESTATE ts)
        {
            switch (ts)
            {
                case Vyroba_P.Odvadeni.FormOdvadeni.TIMESTATE.Korekce_Zahajena:
                case Vyroba_P.Odvadeni.FormOdvadeni.TIMESTATE.Priprava_Zahajena:
                    return Color.Yellow;
                case Vyroba_P.Odvadeni.FormOdvadeni.TIMESTATE.Odvod_Zahajen:
                    return Color.Green;
                case Vyroba_P.Odvadeni.FormOdvadeni.TIMESTATE.Korekce_Dokoncena:
                case Vyroba_P.Odvadeni.FormOdvadeni.TIMESTATE.Priprava_Dokoncena:
                case Vyroba_P.Odvadeni.FormOdvadeni.TIMESTATE.Odvod_Dokoncen:
                    return Color.Red;
                case Vyroba_P.Odvadeni.FormOdvadeni.TIMESTATE.Unknown:
                case Vyroba_P.Odvadeni.FormOdvadeni.TIMESTATE.Nezahajeno:
                default:
                    return Color.White;
            }
        }
