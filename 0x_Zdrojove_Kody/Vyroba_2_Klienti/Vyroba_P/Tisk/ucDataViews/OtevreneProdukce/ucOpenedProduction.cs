...
namespace Fask.Vyroba_P.OtevreneProdukce
{
        ...
        private void timerUpdateDataThreadStart()
        {
            ...
            try
            {
                ...
                if(Settings.ModulNedokonceneZakazkyPouzitFiltrNaUzivatele && Globals.Pracovnik != null)
                    dataCE2.ProductionHist.Merge(Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Production_PRD.GetDataByUserID_Production(Globals.Pracovnik.id), false, MissingSchemaAction.Ignore);
                else
                    dataCE2.ProductionHist.Merge(Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Production_PRD.GetData_Production(), false, MissingSchemaAction.Ignore);
                ...
                if (Settings.ModulNedokonceneZakazkyPouzitDataZeServeru)
                {
                    try
                    {
                        ...
                        dsVweb = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.vyrobaServis.Production_AllOpenedProductions();
