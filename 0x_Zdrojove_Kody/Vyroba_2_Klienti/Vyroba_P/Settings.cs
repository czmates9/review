...
namespace Fask.Vyroba_P
{
    public class Settings
    {
        ...
        /// Pokud je vypnuto, zadne korekce neni mozne vkladat, ani nejsou na tomto stroji zadne automaticky vkladane...
        /// </summary>
        public static bool Main_Mereni_Papouch
        {
            get { return bool.Parse(GetValue("Main_Mereni_Papouch", true.ToString())); }
            set { SetValue("Main_Mereni_Papouch", value.ToString()); }
        }
        ...
        public static string PapouchURL
        {
            get
            {
                return GetValue("PapouchURL", "http://192.168.1.254/fresh.xml");
            }
            set
            {
                SetValue("PapouchURL", value);
            }
        }
        ...
        /// </summary>
        public static bool ModulPovolitOdvadeni
        {
        ...
        /// </summary>
        public static int ModulOdvadeniColumn
        {
        ...
        /// </summary>
        public static int ModulOdvadeniColumnSpan
        {
        ...
        /// Poradi sloupce, kde bude umisten modul.
        /// </summary>
        public static int ModulOdvadeniRow
        {
        ...
        /// Rozsireni do strany, kde bude umisten modul.
        /// </summary>
        public static int ModulOdvadeniRowSpan
        {
        ...
        /// <summary>
        /// Vyzaduje zadani zdrojoveho skladu materialu vstupujiciho do vyrobku, z dat
        /// </summary>
        public static bool rB_production_Destination_SKLID_data
        {
            get { return bool.Parse(GetValue("rB_production_Destination_SKLID_data", true.ToString())); }
            set { SetValue("rB_production_Destination_SKLID_data", value.ToString()); }
        }

        /// <summary>
        /// Vyzaduje zadani zdrojoveho skladu materialu vstupujiciho do vyrobku, z dat
        /// </summary>
        public static bool rB_production_Destination_SKLID_value
        {
            get { return bool.Parse(GetValue("rB_production_Destination_SKLID_value", false.ToString())); }
            set { SetValue("rB_production_Destination_SKLID_value", value.ToString()); }
        }
        ...
        /// Vyzaduje zadani zdrojoveho skladu materialu vstupujiciho do vyrobku z dat
        /// </summary>
        public static bool rB_production_Material_Source_SKLID_data
        {
            get { return bool.Parse(GetValue("rB_production_Material_Source_SKLID_data", true.ToString())); }
            set { SetValue("rB_production_Material_Source_SKLID_data", value.ToString()); }
        }

        /// <summary>
        /// Vyzaduje zadani zdrojoveho skladu materialu vstupujiciho do vyrobku
        /// </summary>
        public static bool rB_production_Material_Source_SKLID_value
        {
            get { return bool.Parse(GetValue("rB_production_Material_Source_SKLID_value", false.ToString())); }
            set { SetValue("rB_production_Material_Source_SKLID_value", value.ToString()); }
        }
        ...
        public static Fask.Vyroba_P.Globals.ServerAccessCertificatesTrustType ServerAccessCertificateTrust
        {
            get
            {
                string cert = string.IsNullOrEmpty(GetValue("ServerAccessCertificateTrust", Fask.Vyroba_P.Globals.ServerAccessCertificatesTrustType.TrustAll.ToString())) ? Fask.Vyroba_P.Globals.ServerAccessCertificatesTrustType.OnlyInstalled.ToString() : GetValue("ServerAccessCertificateTrust", Fask.Vyroba_P.Globals.ServerAccessCertificatesTrustType.TrustAll.ToString());
                return (Fask.Vyroba_P.Globals.ServerAccessCertificatesTrustType)Enum.Parse(typeof(Fask.Vyroba_P.Globals.ServerAccessCertificatesTrustType), cert, true);
            }
