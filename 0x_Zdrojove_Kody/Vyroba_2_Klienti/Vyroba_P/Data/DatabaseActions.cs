    ...
    public class DatabaseActions
    {
        public static DateTime? UserLastAction(string UserID)
        {
            ...
            try
            {
                ...
                Fask.SQLiteDBs.DataSets.Vyroba.ProductionDataTable dt_lst_LProduction = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__InternalState_PRD.GetDataByUserID_Production(UserID);
                ...
                try
                {
                    lastUserActionDateTimeServer = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.vyrobaServis.UserLastAction(UserID);
                }
                catch (Exception ex)
                {
        ...
        public static bool insertProductionDataTable(Fask.SQLiteDBs.DataSets.Vyroba.ProductionDataTable dt)
        {
            try
            {
                ...
                Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__InternalState_PRD.DeleteProductionByUserID_Production(dt.First().UserID);

                Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Production_PRD.Update_Production(dt);
                Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__InternalState_PRD.Update_Production(dt);
        ...
        public static bool InsertProduction(Fask.SQLiteDBs.DataSets.Vyroba.ProductionRow i)
        {
            try
            {
                ...
                Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__Production_PRD.Update_Production(i);
                ...
                if (!i.IsTIMECRIDNull())
                {
                    Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__InternalState_PRD.DeleteCorrectionByUserID_Production(i.UserID);
                    
                    Fask.Vyroba_P.Data.DatabaseActions.InsertProductionCache(i);
                }
                else
                {
                    // je odvod
                    Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__InternalState_PRD.DeleteProductionByUserID_Production(i.UserID);
                    Fask.Vyroba_P.Data.DatabaseActions.InsertProductionCache(i);
                }
        ...
        public static bool InsertProductionHistory(Fask.SQLiteDBs.DataSets.Vyroba.ProductionRow i)
        {
            try
            {
                ...
                Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__ProductionHist_PRD.Update_Production(i);
        ...
        public static bool InsertProductionCache(Fask.SQLiteDBs.DataSets.Vyroba.ProductionRow i)
        {
            try
            {
                if (i == null)
                    return false;
                Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.controller_Vyroba__InternalState_PRD.Update_Production(i);
