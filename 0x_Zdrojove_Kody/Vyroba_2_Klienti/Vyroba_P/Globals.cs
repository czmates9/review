            ...
            set
            {
                ...
                switch (_serverAccessCertificateTrust)
                {
                    case Globals.ServerAccessCertificatesTrustType.TrustAll:
                        System.Net.ServicePointManager.CertificatePolicy = new Fask.Vyroba_P.ServerAccess.CertificatesPolicy.TrustAllCertificatePolicy();
                        break;
                    case Globals.ServerAccessCertificatesTrustType.TrustQuery:
                        System.Net.ServicePointManager.CertificatePolicy = new Fask.Vyroba_P.ServerAccess.CertificatesPolicy.QueryTrustCertificatePolicy();
                        break;
