    ...
    class FileOperations
    {
        ...
        public static byte[] DBLoad(string filename)
        {
            ...
            try
            {
                ...
                {
                    Fask.Logging.ExceptionHandler2.Handle( Logging.LogLevel.Error ,"FileOperations", System.Reflection.MethodBase.GetCurrentMethod().Name, "bytesRead < fileLen : " + filename);
                }
            }
            finally
            {
