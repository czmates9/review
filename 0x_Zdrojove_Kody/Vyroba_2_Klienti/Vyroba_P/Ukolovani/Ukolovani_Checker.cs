...
namespace Fask.Vyroba_P.Ukolovani
{
    public class Ukolovani_Checker
    {
        ...
        public static string UkolyInfo(int userID, out int pocetstart, out int pocetend, out int pocetwork)
        {
            ...
            try
            {
                Fask.Vyroba_P.Data.UkolyTableAdapters.CZ_UKOL_UZIVTableAdapter ta_ukoluziv = new Fask.Vyroba_P.Data.UkolyTableAdapters.CZ_UKOL_UZIVTableAdapter();
                Fask.Vyroba_P.Data.UkolyTableAdapters.CZ_UKOL_STATETableAdapter ta_ukolstate = new Fask.Vyroba_P.Data.UkolyTableAdapters.CZ_UKOL_STATETableAdapter();
                ...
                Fask.Vyroba_P.Data.Ukoly.CZ_UKOL_STATEDataTable dt_ukolstate = ta_ukolstate.GetData();

                Fask.Vyroba_P.Data.Ukoly.CZ_UKOL_UZIVDataTable dt_ukoluziv = ta_ukoluziv.GetDataByUserID(userID);
                StringBuilder sb = new StringBuilder();
                foreach (var item in dt_ukoluziv)
                {
                    Fask.Vyroba_P.Data.Ukoly.CZ_UKOL_STATERow r_ukolstate = dt_ukolstate.FindByState(item.State);
                    if (r_ukolstate == null)
                        continue;
        ...
        private void Synchronize()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    string downloaded = "";
                    Fask.Vyroba_P.Data.UkolyTableAdapters.CZ_UKOL_UZIVTableAdapter uota = new Fask.Vyroba_P.Data.UkolyTableAdapters.CZ_UKOL_UZIVTableAdapter();
                    Fask.Vyroba_P.Data.UkolyTableAdapters.CZ_UKOL_UZIVTableAdapter usta = new Fask.Vyroba_P.Data.UkolyTableAdapters.CZ_UKOL_UZIVTableAdapter();
                    Fask.Vyroba_P.Data.UkolyTableAdapters.CZ_UKOLTableAdapter uta = new Fask.Vyroba_P.Data.UkolyTableAdapters.CZ_UKOLTableAdapter();
                    ...
                    // started ... 
                   Fask.Vyroba_P.Data.Ukoly.CZ_UKOL_UZIVDataTable uodt;
                   Fask.Vyroba_P.Data.Ukoly.CZ_UKOL_UZIVDataTable usdt;

                    try
                    {
                        so = Fask.Vyroba_P.Forms.FormMain.Instance_FormMain.globalObject.ukolovaniService.PrepareDB(Settings.TerminalID, int.Parse(Settings.LastProductionUserID), Path.GetFileName(Constants.CiselnikUkolyDBSynch));
                    ...
                    if (downloaded == "OK")
                    {
                        ...
                        {
                           Fask.Vyroba_P.Data.Ukoly.CZ_UKOL_UZIVRow oitem = uodt.FindByID(sitem.ID);
                        ...
                        if (noveukoly.Count > 0) //Jsou nove ukoly, tak nejak zobrazit ...
                        {
                            ...
                            Fask.Vyroba_P.Forms.FormMain main = new Fask.Vyroba_P.Forms.FormMain();
                    ...
                    if (noveukoly.Count <= 0)
                    {
                        ...
                        foreach (var item in uodt)
                        {
                            ...
                            {
                                Fask.Vyroba_P.UkolovaniService.Ukol pUkol = new Fask.Vyroba_P.UkolovaniService.Ukol();
                                pUkol.id = item.ID;
