...
namespace MTOM_Library
{
	...
	public class FileTransferBase : BackgroundWorker
	{
        ...
        protected WebServiceVyrobaFileTransfer.FileTransfer ws;			// the web service object
		...
		public WebServiceVyrobaFileTransfer.FileTransfer WebService
		{
			get
			{
				if(this.ws == null)
				{
                    ws = new MTOM_Library.WebServiceVyrobaFileTransfer.FileTransfer();
