    ...
    public class ScannerCOM : ScannerBase
    {
        ...
        void scannerPort_DataReceived(object sender, System.IO.Ports.SerialDataReceivedEventArgs e)
        {
            try
            {
                ...
                while (scannerPort.BytesToRead > 0)
                {
                    ...
                    {
                        Fask.Logging.ExceptionHandler2.Handle(exscanner);
            ...
            {
                Fask.Logging.ExceptionHandler2.Handle(exscannerdiscard);
            }
        }
        ...
        public override void ScannerSettingSave()
        {
            try
            {
                ...
                TextWriter txtwrite = new StreamWriter(@"Konfigurace\Scanner.xml", false);
            ...
            {
                Fask.Logging.ExceptionHandler2.Handle(this.GetType().ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, ex);
                FlexibleMessageBox.Show(ex.Message, "Saving scanner settings", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error, System.Windows.Forms.MessageBoxDefaultButton.Button1);
            }
        }
        ...
        public override void ScannerSettingLoad()
        {
            try
            {
                ...
                //XmlSerializer xmlser = new XmlSerializer(typeof(ComPortSettings));
                XmlSerializer xmlser = XmlSerializer.FromTypes(new[] { typeof(ComPortSettings) })[0];


                TextReader txtread = new StreamReader(@"Konfigurace\Scanner.xml");
