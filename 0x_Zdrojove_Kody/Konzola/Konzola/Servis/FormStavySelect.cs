...
{
    public partial class FormStavySelect : Form
    {
        ...
        /// </summary>
        private Fask.Interfaces.DataSets.Servis.CZMST_Servis_StavRow selectRow { get; set; }
        ...
        public FormStavySelect(bool allowMultiSelect)
        {
            InitializeComponent();
        ...
        public FormStavySelect(bool allowMultiSelect, Fask.Interfaces.DataSets.Servis.CZMST_Servis_StavRow selectRow)
            : this(allowMultiSelect)
        {
            this.selectRow = selectRow;
        }

        private void FormStavySelect_Load(object sender, EventArgs e)
        {
            try
            {
                this.ShowIcon = false;
        ...
        private void FormStavySelect_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FormStavySelect_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
        ...
        private void dataGridView1_Sorted(object sender, EventArgs e)
        {
            try
            {
                int pos = this.bsServis.Find(dsServis.CZMST_Servis_Stav.IDColumn.ColumnName, selectedStavID);
