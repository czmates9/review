...
{
    public partial class FormReportSestava : Form
    {

        
        //List<string> MenaStlupcu;

        private Fask.Interfaces.IMES providerServis = null;
        private Fask.Interfaces.IMES providerOdberatele = null;
        //private Fask.Interfaces.Ciselniky.IUzivatele providerUzivatele = null;
        ...
        public FormReportSestava()
        {
            InitializeComponent();

            this.dgSestava.UpdateColumnHeaderCellsByDatasource();
        ...
        private void FormReportSestava_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FormReportSestava_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                this.dgSestava.SaveConfiguration(this.GetType().ToString());
        ...
        private void FormReportSestava_Load(object sender, EventArgs e)
        {
            try
            {
                this.ShowIcon = false;
                ...
                this.dgSestava.LoadConfiguration(this.GetType().ToString());
                panelButtons.LoadConfiguration(this.GetType().ToString());
                panelButtons.Init();

                advancedDataGridViewSearchToolBar1.SetColumns(dgSestava.Columns);
        ...
        //                string sort = ((DataView)((BindingSource)dataGridView1.DataSource).List).Sort;
        //                var sortcolumns = sort.Split(new char[] { ',' }, StringSplitOptions.RemoveEmptyEntries).ToList();
        //                var column = sortcolumns.Where(x => x.Contains(this.dataGridView1.Columns[e.ColumnIndex].DataPropertyName));
        ...
        //                        columnnew = String.Format("{0} {1}", this.dataGridView1.Columns[e.ColumnIndex].DataPropertyName, "asc");
        //                    else
        //                        //this.dataGridView1.Columns[e.ColumnIndex].HeaderCell.SortGlyphDirection = SortOrder.Descending;
        //                        columnnew = String.Format("{0} {1}", this.dataGridView1.Columns[e.ColumnIndex].DataPropertyName, "desc");
        ...
        //        if (e.RowIndex < 0
        //            && e.ColumnIndex >= 0
        //            && !String.IsNullOrEmpty(((DataView)((BindingSource)dataGridView1.DataSource).List).Sort)
        //            )
        //        {
        ...
        //            else
        //            {
        //                this.dataGridView1.Columns[e.ColumnIndex].HeaderCell.SortGlyphDirection = SortOrder.None;
        //            }
        //            //this.dataGridView1.Columns[e.ColumnIndex].HeaderCell.SortGlyphDirection = SortOrder.Ascending;
        //        }
        ...
        #region oznaceni exportovanich

        //private void buttonExportOznaceneZrusit_Click(object sender, EventArgs e)
        //{
        //    try
        //    {
        ...
        //        providerServis.UpdateZdrojPohyb((Fask.Interfaces.DataSets.Servis.CZMST_Servis_ZdrojPohybDataTable)((DataView)l).Table);
        ...
        private void LoadDataAsync()
        {
            try
            {
                ...
                //Fask.Interfaces.DataSets.Uzivatele dsUzivateleData = new Fask.Interfaces.DataSets.Uzivatele();
        ...
        private void PopulateUI(Fask.Interfaces.DataSets.Odberatele dsOdberateleData)
        {
            try
            {
        ...
        private void btnZobrazitInformace_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        private void PerformZobrazitInformace()
        {
            try
            {
                ...
                //    Fask.Interfaces.DataSets.Servis.CZMST_Servis_CinnostRow cinnost = providerServis.GetCinnostByID(rowZdrojPohyb.IDCinnost);
                    
                //    // test existence cinnosti
                //    if (cinnost == null)
                //        throw new Exception("Činnost s id '" + rowZdrojPohyb.IDCinnost + "' neexistuje");
                    
                //    Fask.Interfaces.DataSets.Servis.CZMST_Servis_Dynamic_Table_DefinitionRow dyntabdef = providerServis.GetDynamicTableDefinitionByTypeName(cinnost.TYPEVALUE);

                //    // test existence definice dynamicke tabulky
                //    if(dyntabdef == null)
                //        throw new Exception("Činnost s id '" + rowZdrojPohyb.IDCinnost + "' neexistuje");

                //    Fask.Interfaces.DataSets.Servis.CZMST_Servis_Dynamic_TableRow dyntabrow = providerServis.GetDynamicTableByID(dyntabdef.TypeName, rowZdrojPohyb.CinnostValue);
                ...
                //    string path = System.IO.Path.Combine(Settings.ServisImagesDataFileDirectory, rowZdrojPohyb.CinnostValue);
                //    // test existence
        ...
        private void dataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                //{
                //    this.btnZobrazitInformace.Enabled = false;
                //    return;
                //}

                //if ((rowZdrojPohyb.CinnostType == "D") || (rowZdrojPohyb.CinnostType == "P"))
                //{
                //    this.btnZobrazitInformace.Enabled = true;
                //}
                //else
                //    this.btnZobrazitInformace.Enabled = false;
            }
        ...
        {
            #region Vzhledavat podle filtru

            try
            {
                //DataTable dtchanged = this.dsSestava. .CZMST_Servis_ZdrojPohyb.GetChanges();
                ...
                Fask.Interfaces.Filtry.ReportSestavaFiltr filtr = new Fask.Interfaces.Filtry.ReportSestavaFiltr();


           

                if (!Clearfilter(ref filtr))
                    return;
        ...
        /// <returns></returns>
        private bool CreateFilter(ref Fask.Interfaces.Filtry.ReportSestavaFiltr filtr)
        {
            if (filtr == null)
                filtr = new Fask.Interfaces.Filtry.ReportSestavaFiltr();
            ...
            var row = cbOkruh.SelectedItem as Fask.Interfaces.DataSets.Servis.CZMST_Servis_OkruhRow;

            filtr.OkruhID = row == null ? string.Empty : row.ID ;

            filtr.PoMereni = rb_pomereni.Checked;
            filtr.PoMesici = rb_pomesici.Checked;
            filtr.PoRoce = rb_poroce.Checked;

            return true;
        }

        private bool Clearfilter(ref Fask.Interfaces.Filtry.ReportSestavaFiltr filtr) 
        {

            filtr.rowOdberatelID = null;
            filtr.OdberatelID = string.Empty;
            filtr.DatumOd = null;
            filtr.DatumDo = null;

            //var row = cbOkruh.SelectedItem as Fask.Interfaces.DataSets.Servis.CZMST_Servis_OkruhRow;

            filtr.OkruhID = string.Empty;

            filtr.PoMereni =false ;
            filtr.PoMesici = false ;
            filtr.PoRoce = false;
        ...
        private void bwLoadData_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                Fask.Interfaces.Filtry.ReportSestavaFiltr filtr = (Fask.Interfaces.Filtry.ReportSestavaFiltr)e.Argument;
                ...
                var ds = ((Fask.Interfaces.Servis.IServis)providerServis).GetFiltrovanyZdrojPohyb(filtr);
                if (bwLoadData.CancellationPending)
                {
                    e.Cancel = true;
                    return;
        ...
        private void bwLoadData_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            ////TaD odkomentuj filtry ked bude dsServis
            try
            {
                ...
                {
                    // handle the error
                    dsSestava = new Fask.Interfaces.DataSets.Servis();
                    bsSestava.DataSource = dsSestava;
                ...
                else
                {
                    ...
                    dsSestava = (DataSet)e.Result;
                    if (dsSestava == null)
                        dsSestava = new DataSet();

                    bsSestava.DataSource = dsSestava;

                    bsSestava.DataMember = dsSestava.Tables[0].TableName;

                   //string nametable = dsSestava.Tables[0].TableName;

                    dgSestava.Columns.Clear();

                    foreach (DataColumn item in dsSestava.Tables[0].Columns)
                    {
                        //MenaStlupcu.Add(item.ColumnName);
                        int index;
                        ...
                        {
                            case "ZdrojID":
                                index = dgSestava.Columns.Add(item.ColumnName, "ID Zdroje");
                                column = dgSestava.Columns[index];
                                column.DataPropertyName = item.ColumnName;
                                break;
                            case "ZdrojOznaceni":
                                index = dgSestava.Columns.Add(item.ColumnName, "Označení zdroje");
                                column = dgSestava.Columns[index];
                                column.DataPropertyName = item.ColumnName;
                                break;
                            case "ZdrojMisto":
                                index = dgSestava.Columns.Add(item.ColumnName, "Místo Zdroje");
                                column = dgSestava.Columns[index];
                                column.DataPropertyName = item.ColumnName;
                                break;
                            case "OkruhID":
                                index = dgSestava.Columns.Add(item.ColumnName, "ID Okruhu");
                                column = dgSestava.Columns[index];
                                column.DataPropertyName = item.ColumnName;
                                break;
                            case "OkruhOznaceni":
                                index = dgSestava.Columns.Add(item.ColumnName, "Označení okruhu");
                                column = dgSestava.Columns[index];
                                column.DataPropertyName = item.ColumnName;
                                break;
                            case "ZdrojSeznamPoradi":
                                index = dgSestava.Columns.Add(item.ColumnName, "Pořadí zdroje v seznamu");
                                column = dgSestava.Columns[index];
                                column.DataPropertyName = item.ColumnName;
                                break;
                            case "ZdrojSeznamID":
                                index = dgSestava.Columns.Add(item.ColumnName, "ID zdroje v seznamu");
                                column = dgSestava.Columns[index];
                                column.DataPropertyName = item.ColumnName;
                                break;
                            case "ODB_ID":
                                index = dgSestava.Columns.Add(item.ColumnName, "ID Odběratele");
                                column = dgSestava.Columns[index];
                                column.DataPropertyName = item.ColumnName;
                                break;
                            default:
                                index = dgSestava.Columns.Add(item.ColumnName, item.ColumnName);
                                column = dgSestava.Columns[index];
                                column.DataPropertyName = item.ColumnName;
                                break;
                        }
                    ...
                    //if (rb_pomereni.Checked)
                    //{
                    //    dataGridView1.Columns.Add("ZdrojOznaceni", "ZdrojOznaceni");
                    //    dataGridView1.Columns.Add("ZdrojMisto", "ZdrojMisto");
                    //    dataGridView1.Columns.Add("ZdrojType", "ZdrojType");
                    //}
                    //else if (rb_pomesici.Checked)
                    //{
                    //    dataGridView1.Columns.Add("StavOznaceni", "StavOznaceni");
                    //    dataGridView1.Columns.Add("CinnostNazev", "CinnostNazev");
                    //    dataGridView1.Columns.Add("OdberatelOznaceni", "OdberatelOznaceni");
                    //}
                    //else if (rb_poroce.Checked)
                    //{
                    //    dataGridView1.Columns.Add("UzivatelPrijmeni", "UzivatelPrijmeni");
                    //    dataGridView1.Columns.Add("UzivatelJmeno", "UzivatelJmeno");
                    //    dataGridView1.Columns.Add("UzivatelJmeno", "OkruhOznaceni");
                    //}
                    ...
                    //sestaveni datagriv stloupce


                  //DataRowCollection rows = dsSestava.Tables["CZMST_Servis_ZdrojPohyb"].Rows;

                  //Fask.Interfaces.DataSets.Servis.CZMST_Servis_ZdrojDataTable dtzp = new Fask.Interfaces.DataSets.Servis.CZMST_Servis_ZdrojDataTable();



                  //foreach (DataRow item in rows)
                  //{
                  //  Fask.Interfaces.DataSets.Servis.CZMST_Servis_ZdrojRow row = dtzp.NewCZMST_Servis_ZdrojRow();
                  //   row  = (Fask.Interfaces.DataSets.Servis.CZMST_Servis_ZdrojRow)item;
                  //   dtzp.AddCZMST_Servis_ZdrojRow(row);
                  //}
        ...
        private void ProgressIndicatorStart()
        {
            try
            {
                ...
                this.progressIndicator1.Location = new Point(this.dgSestava.Location.X + (this.dgSestava.Width / 2) - (progressIndicator1.Size.Width / 2), this.dgSestava.Location.Y + (this.dgSestava.Height / 2) - (progressIndicator1.Size.Height / 2));
            }
            catch { }
        ...
        private void comboBoxODB_ID_SelectedIndexChanged(object sender, EventArgs e)
        {

            //object a = ((ComboBox)sender).SelectedItem;

            var row = comboBoxODB_ID.SelectedItem as Fask.Interfaces.DataSets.Odberatele.CZMST090Row;
            var dt_Servis_Okruh = ((Fask.Interfaces.Servis.IServis)providerServis).GetOkruhByOBDID(row.odb_id);

            //Fask.Interfaces.DataSets.Servis.CZMST_Servis_OkruhDataTable dt_Servis_Okruh = providerServis.GetOkruhByOBDID(((Fask.Interfaces.DataSets.Odberatele.CZMST090Row)comboBoxODB_ID.SelectedItem).odb_id);
             cbOkruh.SelectedText = string.Empty;
             cbOkruh.Text = string.Empty;


             cbOkruh.Items.Clear();

            cbOkruh.Items.AddRange(dt_Servis_Okruh.Select(null, "ID asc"));
            cbOkruh.SelectedItem = null;
        }

        private void tsmiTisknoutVse_Click(object sender, EventArgs e)
        {
            //    try
            //    {


            //        if (dsServis.CZMST_Servis_ZdrojPohyb.Count <= 0 || dsServis.CZMST_Servis_ZdrojPohyb.Count == null)
            //        {
        ...
        private void tsmiTisknoutOznacene_Click(object sender, EventArgs e)
        {
        //    try
        //    {

        //        if (dataGridView1.SelectedRows.Count <= 0 || dataGridView1.SelectedRows.Count == null)
        //        {
        ...
        //        new Microsoft.Reporting.WinForms.ReportParameter("Status" ,"Výběr"),
        ...
        private void advancedDataGridViewSearchToolBar1_Search(object sender, Zuby.ADGV.AdvancedDataGridViewSearchToolBarSearchEventArgs e)
        {
            ...
            if (!e.FromBegin)
            {
                bool endcol = dgSestava.CurrentCell.ColumnIndex + 1 >= dgSestava.ColumnCount;
                bool endrow = dgSestava.CurrentCell.RowIndex + 1 >= dgSestava.RowCount;

                if (endcol && endrow)
                {
                    startColumn = dgSestava.CurrentCell.ColumnIndex;
                    startRow = dgSestava.CurrentCell.RowIndex;
                }
                else
                {
                    startColumn = endcol ? 0 : dgSestava.CurrentCell.ColumnIndex + 1;
                    startRow = dgSestava.CurrentCell.RowIndex + (endcol ? 1 : 0);
                }
            }
            DataGridViewCell c = dgSestava.FindCell(
                e.ValueToSearch,
        ...
        private void exportDoCSVVseToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dgSestava.ExportToCSV(Fask.Interfaces.Classes.EXPORT_DAT.VSE);
            }
            catch (Exception ex)
            {
                Fask.Logging.ExceptionHandler2.Handle(this.GetType().ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, ex);
        ...
        private void exportDoCSVOznaceneToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dgSestava.ExportToCSV(Fask.Interfaces.Classes.EXPORT_DAT.OZNACENE);
            }
            catch (Exception ex)
            {
                Fask.Logging.ExceptionHandler2.Handle(this.GetType().ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, ex);
        ...
        private void exportDoExcelVseToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dgSestava.ExportToExcel(Fask.Interfaces.Classes.EXPORT_DAT.VSE);
            }
            catch (Exception ex)
            {
                Fask.Logging.ExceptionHandler2.Handle(this.GetType().ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, ex);
        ...
        private void exportDoExceOznaceneToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dgSestava.ExportToExcel(Fask.Interfaces.Classes.EXPORT_DAT.OZNACENE);
            }
            catch (Exception ex)
            {
                Fask.Logging.ExceptionHandler2.Handle(this.GetType().ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, ex);
        ...
        private void exportDoXMLVseToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dgSestava.ExportToXML(Fask.Interfaces.Classes.EXPORT_DAT.VSE);
            }
            catch (Exception ex)
            {
                Fask.Logging.ExceptionHandler2.Handle(this.GetType().ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, ex);
        ...
        private void exportDoXMLOznaceneToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dgSestava.ExportToXML(Fask.Interfaces.Classes.EXPORT_DAT.OZNACENE);
            }
            catch (Exception ex)
            {
                Fask.Logging.ExceptionHandler2.Handle(this.GetType().ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, ex);
