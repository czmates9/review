...
{
    public partial class FormCinnostiList : Form
    {
        /// <summary>
        ...
        private void FormCinnostiList_Load(object sender, EventArgs e)
        {
            try
            {
                this.ShowIcon = false;
        ...
        private void FormCinnostiList_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FormCinnostiList_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
        ...
        private void PerformCreateRecord()
        {
            try
            {
                ...
                using (Servis.FormCinnostiEdit frmcinnosti = new FormCinnostiEdit())
                {
                    frmcinnosti.Text = "Nová činnost";
                    if (frmcinnosti.ShowDialog(this) != DialogResult.OK)
                        return;
                    UpdateForm(frmcinnosti.returnrow);
                }
            }
            catch (Exception ex)
            {
        ...
        private void PerformEditRecord()
        {
            try
            {
                ...
                using (Servis.FormCinnostiEdit frmcinnosti = new FormCinnostiEdit())
                {
                    frmcinnosti.cinnostrow = SelectedRow;
                    frmcinnosti.Text = "Úprava činnosti";
                    if (frmcinnosti.ShowDialog(this) != DialogResult.OK)
                        return;
        ...
        private void PerformDeleteRecord()
        {
            try
            {
                ...
                if (MessageBox.Show("Opravdu chcete odstranit činnost '" + SelectedRow.Oznaceni.Trim()  + "'?", this.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.No)
                    return;
                ...
                bool result = ((Fask.Interfaces.Servis.IServis)providerServis).DeleteCinnost(SelectedRow.ID); //, odstranitNavaznosti);
