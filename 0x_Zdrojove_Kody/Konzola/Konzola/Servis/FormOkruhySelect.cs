...
{
    public partial class FormOkruhySelect : Form
    {
        ...
        /// </summary>
        private Fask.Interfaces.DataSets.Servis.CZMST_Servis_OkruhRow selectRow { get; set; }
        ...
        public FormOkruhySelect(bool allowMultiSelect)
        {
            InitializeComponent();
        ...
        public FormOkruhySelect(bool allowMultiSelect, Fask.Interfaces.DataSets.Servis.CZMST_Servis_OkruhRow selectRow)
            : this(allowMultiSelect)
        {
            this.selectRow = selectRow;
        }

        private void FormOkruhySelect_Load(object sender, EventArgs e)
        {
            try
            {
                this.ShowIcon = false;
        ...
        private void FormOkruhySelect_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FormOkruhySelect_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
        ...
        private void PopulateUI(Fask.Interfaces.DataSets.Servis ds)
        {
            try
            {
                ...
                try
                {
                    ...
                    if (selectRow != null)
                    {
                        int index = bsServis.Find(dsServis.CZMST_Servis_Okruh.IDColumn.ColumnName, selectRow.ID);
