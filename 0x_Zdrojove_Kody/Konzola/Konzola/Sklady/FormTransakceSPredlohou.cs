...
{
    public partial class FormTransakceSPredlohou : Form
    {
        ...
        public FormTransakceSPredlohou()
        {
            InitializeComponent();
        ...
        public FormTransakceSPredlohou(bool opravneni) : this()
        {
        ...
        private void FormTransakceSPredlohou_Load(object sender, EventArgs e)
        {
            try
            {


                rB_Polozka_vsechny.Checked = true;
        ...
        private void FormTransakceSPredlohou_Shown(object sender, EventArgs e)
        {
            try
            {
        ...
        private void FormTransakceSPredlohou_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FormTransakceSPredlohou_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
        ...
        private bool CreateFilter(ref Fask.Interfaces.Filtry.VydejDavkyFiltr filtr)
        {
            ...
            filtr.TypPolozky = tB_TypPolozky.Text;
            filtr.PriznakDavky = tB_Priznak_davky.Text;
            filtr.PriznakPolozky_vsechny = rB_Polozka_vsechny.Checked;
            filtr.PriznakPolozky_vykryte = rB_Polozka_vykryte.Checked;
            filtr.PriznakPolozky_nevykryte= rB_Polozka_nevykryte.Checked;
            filtr.PriznakPolozky_neplnene = rB_Polozka_neplnene.Checked;
        ...
        private void PerformNastavitFiltr(Fask.Interfaces.Filtry.VydejDavkyFiltr filtr)
        {
            try
            {
                ...
                tB_TypPolozky.Text = filtr.TypPolozky ;
                tB_Priznak_davky.Text = filtr.PriznakDavky;
                rB_Polozka_vsechny.Checked = filtr.PriznakPolozky_vsechny;
                rB_Polozka_vykryte.Checked = filtr.PriznakPolozky_vykryte;
                rB_Polozka_nevykryte.Checked = filtr.PriznakPolozky_nevykryte;
                rB_Polozka_neplnene.Checked = filtr.PriznakPolozky_neplnene;
        ...
        private void PerformVycistitFiltr()
        {
            try
            {
                ...
                tB_TypPolozky.Text = string.Empty;
                tB_Priznak_davky.Text = string.Empty;
                rB_Polozka_vsechny.Checked = true;
                rB_Polozka_vykryte.Checked = false;
                rB_Polozka_nevykryte.Checked = false;
                rB_Polozka_neplnene.Checked = false;
