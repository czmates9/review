...
{
    public partial class FormLokaceMapaGenerovani : Form
    {
        ...
        public FormLokaceMapaGenerovani()
        {
            InitializeComponent();
        }
        ...
        private void Vypocitaj()
        {
            ...
            int N = Konfigurace.Globals_Konfig_Konzola.Konfigurace.Sklady_Ostatni[0].FormLokaceMapaGenerovaniLokaci_N;
            ...
            try
            {
                ...
                {
                    throw new Exception("Nenalezena počáteční Lokace");
                }
                ...
                if (!string.IsNullOrEmpty(tb_Do.Text))
                {
                    ...
                    if (KodPrefix.Trim() != prefixEND.Trim())
                        throw new Exception("Prefix lokace Od a lokace Do musí byt totožne");
                    ...
                    if (count <= 0)
                    {
                        throw new Exception("Počáteční lokace je větší než koncová lokace");
                    }
