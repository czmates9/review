...
{
    public partial class FormLokaceTypyList : Form
    {
        ...
        public FormLokaceTypyList(bool allowMultiSelect, Fask.Interfaces.Classes.ZOBRAZENI_TYP typZobrazeni, Opravneni opravneni)
        {
            InitializeComponent();
        ...
        public Fask.Interfaces.DataSets.SkladLokace.CZMST_SkladLokace_LokaceTypyRow CZMST_SkladLokace_LokaceTypy_selectedRow
        {
            get
            {
                try
        ...
        private List<Fask.Interfaces.DataSets.SkladLokace.CZMST_SkladLokace_LokaceTypyRow> CZMST_SkladLokace_LokaceTypy_selectedRows
        {
            //get
            //{
            //    List<Fask.Interfaces.DataSets.SkladLokace.CZMST_SkladLokace_LokaceTypyRow> rows = new List<Fask.Interfaces.DataSets.SkladLokace.CZMST_SkladLokace_LokaceTypyRow>();

            //    foreach (DataGridViewRow selectedRow in dgSkladLokace.SelectedRows)
            //    {
            //        Fask.Interfaces.DataSets.SkladLokace.CZMST_SkladLokace_LokaceTypyRow row = ((DataRowView)selectedRow.DataBoundItem).Row as Fask.Interfaces.DataSets.SkladLokace.CZMST_SkladLokace_LokaceTypyRow;
            //        rows.Add(row);
            //    }
            ...
            get
            {
                return dgSkladLokace.SelectedRows
                    ...
                    .Select(r => ((DataRowView)r.DataBoundItem).Row as Fask.Interfaces.DataSets.SkladLokace.CZMST_SkladLokace_LokaceTypyRow)
                    .Where(r => r != null)
                    .ToList();
            }
        }

        private List<Fask.Interfaces.Filtry.LokaceTypyListFiltr> filtry = new List<Fask.Interfaces.Filtry.LokaceTypyListFiltr>();

        private Fask.Interfaces.Filtry.LokaceTypyListFiltr rowFiltr
        {
            get
            {
                try
                {
                    return tscbFiltry.SelectedItem as Fask.Interfaces.Filtry.LokaceTypyListFiltr;
                }
                catch
                {
                    return null;
        ...
        public FormLokaceTypyList(bool allowMultiSelect, Fask.Interfaces.Classes.ZOBRAZENI_TYP typZobrazeni)
        {
            InitializeComponent();
            this.dgSkladLokace.UpdateColumnHeaderCellsByDatasource();
            this.dgSkladLokace.MultiSelect = allowMultiSelect;
        ...
        private void FormLokaceTypyList_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                this.filtry = Extensions.ListExt.ReadFromXML<Fask.Interfaces.Filtry.LokaceTypyListFiltr>(this.GetType().ToString() + ".filtr");
        ...
        private void FormLokaceTypyList_Shown(object sender, EventArgs e)
        {
            try
            {
        ...
        private void FormLokaceTypyList_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
        ...
        private void FormLokaceTypyList_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void LoadDataAsync()
        {
            try
            {
                ...
                //ds = ((Fask.Interfaces.Ciselniky.ISkladLokace_LokaceTypy)providerLokaceTypy).GetSkladLokace_LokaceTypy();

                if ((providerLokaceTypy != null) && (providerLokaceTypy is Fask.Interfaces.Ciselniky.SkladLokace_LokaceTypy.ISkladLokace_LokaceTypy2_GetSkladLokace_LokaceTypy))
                    ds = ((Fask.Interfaces.Ciselniky.SkladLokace_LokaceTypy.ISkladLokace_LokaceTypy2_GetSkladLokace_LokaceTypy)providerLokaceTypy).GetSkladLokace_LokaceTypy();
                else
        ...
        private void UpdateForm(Fask.Interfaces.DataSets.SkladLokace.CZMST_SkladLokace_LokaceTypyRow row)
        {
            try
            {
                ...
                dsSkladLokace.Clear();
                //dsSkladLokace = ((Fask.Interfaces.Ciselniky.ISkladLokace_LokaceTypy)providerLokaceTypy).GetSkladLokace_LokaceTypy();
                ...
                if ((providerLokaceTypy != null) && (providerLokaceTypy is Fask.Interfaces.Ciselniky.SkladLokace_LokaceTypy.ISkladLokace_LokaceTypy2_GetFiltrovaneSkladLokace_LokaceTypy ))
                    dsSkladLokace = ((Fask.Interfaces.Ciselniky.SkladLokace_LokaceTypy.ISkladLokace_LokaceTypy2_GetFiltrovaneSkladLokace_LokaceTypy)providerLokaceTypy).GetFiltrovaneSkladLokace_LokaceTypy(filtr);
                else
        ...
        private void PerformCreateRecord()
        {
            try
            {
                ...
                using (Ciselniky.FormLokaceTypyEdit frmodberatele = new FormLokaceTypyEdit())
                {
                    frmodberatele.Text = "Nový typ lokace";
        ...
        private void PerformEditRecord()
        {
            try
            {
                ...
                if (CZMST_SkladLokace_LokaceTypy_selectedRow == null)
                {
                    MessageBox.Show("Není vybrán záznam pro úpravu", this.Text, MessageBoxButtons.OK);
                    return;
                }

                using (Ciselniky.FormLokaceTypyEdit frmodberatele = new Ciselniky.FormLokaceTypyEdit())
                {
                    frmodberatele.typlokacerow = CZMST_SkladLokace_LokaceTypy_selectedRow;
        ...
        private void PerformDeleteRecord()
        {
            try
            {
                ...
                if (MessageBox.Show("Opravdu chcete odstranit typ lokace '" + (CZMST_SkladLokace_LokaceTypy_selectedRow.IsTYPENull() ? string.Empty : CZMST_SkladLokace_LokaceTypy_selectedRow.TYPE.Trim()) + "'?", this.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.No)
                    return;
                ...
                //bool result = ((Fask.Interfaces.Ciselniky.ISkladLokace_LokaceTypy)providerLokaceTypy).DeleteSkladLokace_LokaceTypy(SelectedRow.IsTYPENull() ? string.Empty : SelectedRow.TYPE);
                bool result;

                if ((providerLokaceTypy != null) && (providerLokaceTypy is Fask.Interfaces.Ciselniky.SkladLokace_LokaceTypy.ISkladLokace_LokaceTypy2_DeleteSkladLokace_LokaceTypy))
                    result = ((Fask.Interfaces.Ciselniky.SkladLokace_LokaceTypy.ISkladLokace_LokaceTypy2_DeleteSkladLokace_LokaceTypy)providerLokaceTypy).DeleteSkladLokace_LokaceTypy(CZMST_SkladLokace_LokaceTypy_selectedRow.IsTYPENull() ? string.Empty : CZMST_SkladLokace_LokaceTypy_selectedRow.TYPE);
                else
                    throw new NotImplementedException("Provider neimplementuje ISkladLokace_LokaceTypy2_DeleteSkladLokace_LokaceTypy.");


                UpdateForm(CZMST_SkladLokace_LokaceTypy_selectedRow);
            }
            catch (Exception ex)
            {
                Fask.Logging.ExceptionHandler2.Handle(this.GetType().ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, ex);
        ...
        private void dataGridView1_Sorted(object sender, EventArgs e)
        {
            try
            {
                int pos = this.bsSkladLokace.Find(dsSkladLokace.CZMST_SkladLokace_LokaceTypy.TYPEColumn.ColumnName, selectedOdbID);
        ...
        private void dataGridView1_CellMouseDown(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                if (e.RowIndex == -1)
                {
                    if (CZMST_SkladLokace_LokaceTypy_selectedRow != null && !CZMST_SkladLokace_LokaceTypy_selectedRow.IsTYPENull())
                        selectedOdbID = CZMST_SkladLokace_LokaceTypy_selectedRow.TYPE;
                }
            }
            catch { }
        }
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (Zobrazeni == Fask.Interfaces.Classes.ZOBRAZENI_TYP.LIST)
            {
                if (e.RowIndex != -1)
                    PerformEditRecord();
            }
        ...
        /// <returns></returns>
        private bool CreateFilter(ref Fask.Interfaces.Filtry.LokaceTypyListFiltr filtr)
        {
            if (filtr == null)
                filtr = new Fask.Interfaces.Filtry.LokaceTypyListFiltr();

            filtr.type = tb_Typ.Text.Trim();
            //filtr.Oznaceni = tb_Popis.Text.Trim();
            filtr.is_normal = checkBox_Bezna.Checked;
            filtr.is_receive = checkBox_Prijm.Checked;
            filtr.is_default = checkBox_vychoz.Checked;
        ...
        /// </summary>
        /// <param name="filtr"></param>
        private void PerformNastavitFiltr(Fask.Interfaces.Filtry.LokaceTypyListFiltr filtr)
        {
            try
            {
                if (filtr == null)
                ...
                tb_Typ.Text = filtr.type ;
                //tb_Popis.Text = filtr.Oznaceni;
                checkBox_Bezna.Checked = filtr.is_normal;
                checkBox_Prijm.Checked = filtr.is_receive;
                checkBox_vychoz.Checked = filtr.is_default;
            }
            catch (Exception ex)
            {
                Fask.Logging.ExceptionHandler2.Handle(this.GetType().ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, ex);
        ...
        private void PerformVycistitFiltr()
        {
            try
            {
                tb_Typ.Text = string.Empty;
                //tb_Popis.Text = string.Empty;
                checkBox_Bezna.Checked = false;
                checkBox_Prijm.Checked = false;
                checkBox_vychoz.Checked = false;
            }
            catch (Exception ex)
            {
                Fask.Logging.ExceptionHandler2.Handle(this.GetType().ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, ex);
        ...
        private void PerformZmenitFiltr()
        {
            try
            {
                ...
                Fask.Interfaces.Filtry.LokaceTypyListFiltr filtr = rowFiltr;
        ...
        private void buttonVybratTyp_Click(object sender, EventArgs e)
        {
            PerformOK();
        }
        ...
        private void PerformPrint()
        {
            try
            {
                ...
                if (CZMST_SkladLokace_LokaceTypy_selectedRows.Count > 1)
                {
                    //MessageBox.Show("Je vybráno více záznamů než jeden.", this.Text, MessageBoxButtons.OK);
                    //return;
                }

                Fask.Interfaces.DataSets.SkladLokace.CZMST_SkladLokace_LokaceTypyDataTable dt = new Fask.Interfaces.DataSets.SkladLokace.CZMST_SkladLokace_LokaceTypyDataTable();

                foreach (Fask.Interfaces.DataSets.SkladLokace.CZMST_SkladLokace_LokaceTypyRow row in CZMST_SkladLokace_LokaceTypy_selectedRows)
                {
                    try
                    {
                        Fask.Interfaces.DataSets.SkladLokace.CZMST_SkladLokace_LokaceTypyRow newRow = dt.NewCZMST_SkladLokace_LokaceTypyRow();
                        ...
                        dt.AddCZMST_SkladLokace_LokaceTypyRow(newRow);
                    }
                    catch (Exception ex)
                    {
                        // Ošetření vyjimky
        ...
        private void PrintReport(Fask.Interfaces.DataSets.SkladLokace.CZMST_SkladLokace_LokaceTypyDataTable dt)
        {
            try
            {
                ...
                if (Konfigurace.Globals_Konfig_Konzola.Konfigurace.System[0].Log_Tisky_hl)
                {
                    ...
                    {
                        Fask.Logging.ExceptionHandler2.Handle(LogLevel.PrintInfo, "---------------------------------------Start sklady,typy lokaci TISK rdlc-------------------------------------");
                        ...
                        Fask.Logging.ExceptionHandler2.Handle(LogLevel.PrintInfo, "---------------------------------------END sklady,typy lokaci TISK rdlc-------------------------------------");
                    }
        ...
        private void Perform_Tisk_Selected_Primy_Tisk(string klicTyp, string NazevVychoziTiskarny, string pocetVytisku)
        {
            try
            {
                ...
                foreach (var item in CZMST_SkladLokace_LokaceTypy_selectedRows)
                {

                    if (Konfigurace.Globals_Konfig_Konzola.Konfigurace.System[0].Log_Tisky_hl)
                    {
                        Fask.Logging.ExceptionHandler2.Handle(LogLevel.PrintInfo, "---------------------------------------Start Sklady/Ciselniky/TypyLokaci TISK zpl zaznam: " + index_zaznamu.ToString() + "-------------------------------------");
                        ...
                        Fask.Logging.ExceptionHandler2.Handle(LogLevel.PrintInfo, "---------------------------------------END Sklady/Ciselniky/TypyLokaci TISK zpl zaznam: " + index_zaznamu.ToString() + "-------------------------------------");
                ...
                else
                {
                    ...
                    Tisk_selected_rows_Primy_Tisk(plr_Path, true, MN_ToTisk, CZMST_SkladLokace_LokaceTypy_selectedRows, NazevVychoziTiskarny);
        ...
        private void Tisk_selected_rows_Primy_Tisk(string plr_Path, bool MnozstvuAutoJedna, int MN_ToTisk, List<Fask.Interfaces.DataSets.SkladLokace.CZMST_SkladLokace_LokaceTypyRow> FASK_ZASOBY_selected_Rows, string nazevVychTiskarny)
        {
            try
            {
        ...
        private void PrintReport_RDLC(Fask.Interfaces.DataSets.SkladLokace.CZMST_SkladLokace_LokaceTypyDataTable dt, bool primyTisk, string path_sablona, string nazevVychTiskarny, int pocetVytisku)
        {
            try
            {
                ...
                if (Konfigurace.Globals_Konfig_Konzola.Konfigurace.System[0].Log_Tisky_hl)
                {
                    foreach (var item in dt)
                    {
                        Fask.Logging.ExceptionHandler2.Handle(LogLevel.PrintInfo, "---------------------------------------Start Sklady/Ciselniky/TypyLokaci TISK rdlc-------------------------------------");
                        ...
                        Fask.Logging.ExceptionHandler2.Handle(LogLevel.PrintInfo, "---------------------------------------END Sklady/Ciselniky/TypyLokaci TISK rdlc-------------------------------------");
                    }
                }
        ...
        private void Perform_Tisk_Selected(string klicTyp, string NazevVychoziTiskarny, string pocetVytisku)
        {
            try
            {
                ...
                else
                {
                    ...
                    Tisk_selected_rows(plr_Path, true, MN_ToTisk, CZMST_SkladLokace_LokaceTypy_selectedRows);
        ...
        private void Tisk_selected_rows(string plr_Path, bool MnozstvuAutoJedna, int MN_ToTisk, List<Fask.Interfaces.DataSets.SkladLokace.CZMST_SkladLokace_LokaceTypyRow> FASK_ZASOBY_selected_Rows)
        {
            try
            {
        ...
        private string PrepareDataToTisk(
            string strPath,
            Fask.Interfaces.DataSets.SkladLokace.CZMST_SkladLokace_LokaceTypyRow row,
            int? mnozstviDoTisku
            )
        {
            try
        ...
        private Dictionary<string, string> PrepareDataToTisk(Fask.Interfaces.DataSets.SkladLokace.CZMST_SkladLokace_LokaceTypyRow productionRow_data)
        {
            try
            {
                while (true)
