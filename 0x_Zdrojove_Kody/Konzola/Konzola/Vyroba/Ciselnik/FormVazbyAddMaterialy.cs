...
{
    public partial class FormVazbyAddMaterialy : Form
    {
        ...
        private void FormVazbyAddMaterialy_Load(object sender, EventArgs e)
        {
            try
            {
                this.ShowIcon = false;
        ...
        private void FormVazbyAddMaterialy_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FormVazbyAddMaterialy_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
        ...
        public void InsertMaterial()
        {
            ...
            foreach (DataGridViewRow row in this.dgProduct.SelectedRows)
            {
                ...
                Fask.Interfaces.DataSets.Zbozi.FASK_ZASOBY_KONZOLARow rowMaterial_zbozi;
                //= ds.FASK_Vyroba_TP_Material.NewFASK_Vyroba_TP_MaterialRow();
                rowMaterial_zbozi = ((DataRowView)row.DataBoundItem).Row as Fask.Interfaces.DataSets.Zbozi.FASK_ZASOBY_KONZOLARow;


                using (FormVazbyAddMaterialyEdit VazbyAddMaterialyEdit = new FormVazbyAddMaterialyEdit())
                {
                    VazbyAddMaterialyEdit.Text = "Přidání materálu";
                    VazbyAddMaterialyEdit.edittype = EditType.AddMaterial;
                    VazbyAddMaterialyEdit.rowVyrobek = rowVyrobek;
                    VazbyAddMaterialyEdit.rowMaterial_zbozi = rowMaterial_zbozi;
        ...
        private void tabControl1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                //tacons.FillByIDL_itemnmbr(DataSet_Pridane.FASK_Vyroba_TP_Material, rowVyrobek.ITEMNMBR, rowVyrobek.ID_L);
        ...
        private void ProgressIndicatorADDStart()
        {
            try
            {
                ...
                this.progressIndicatorProduct.Location = new Point(this.dgProduct.Location.X + (this.dgProduct.Width / 2) - (progressIndicatorProduct.Size.Width / 2), this.dgProduct.Location.Y + (this.dgProduct.Height / 2) - (progressIndicatorProduct.Size.Height / 2));
            }
            catch { }
            progressIndicatorProduct.Start();
        ...
        private void PerformNastavitFiltr(Fask.Interfaces.Filtry.VazbyMaterialyFiltr filtr)
        {
            try
            {
                ...
                comboBox_AddMaterial_LOCNCODE.Text = filtr.MaterialLocncode;
                comboBox_AddMaterial_SKL_ID.Text = filtr.MaterialSklID;
                comboBox_AddMaterial_ITEMDESC.Text = filtr.MaterialITEMDESC;
                comboBox_AddMaterial_VNDITNUM.Text = filtr.MaterialVNDITNUM;
                comboBox_AddMaterial_CZ_CarKod.Text = filtr.MaterialCarKod;
            }
            catch (Exception ex)
            {
                Fask.Logging.ExceptionHandler2.Handle(this.GetType().ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, ex);
        ...
        private void PerformVycistitFiltr()
        {
            try
            {
                ...
                comboBox_AddMaterial_LOCNCODE.SelectedItem  =
                comboBox_AddMaterial_SKL_ID.SelectedItem    =
                comboBox_AddMaterial_ITEMDESC.SelectedItem  =
                comboBox_AddMaterial_VNDITNUM.SelectedItem  =
                comboBox_AddMaterial_CZ_CarKod.SelectedItem = null;


                comboBox_AddMaterial_ITEMNMBR.Text  =
                comboBox_AddMaterial_LOCNCODE.Text  =
                comboBox_AddMaterial_SKL_ID.Text    =
                comboBox_AddMaterial_ITEMDESC.Text  =
                comboBox_AddMaterial_VNDITNUM.Text  =
                comboBox_AddMaterial_CZ_CarKod.Text = string.Empty;
            }
            catch (Exception ex)
            {
                Fask.Logging.ExceptionHandler2.Handle(this.GetType().ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name, ex);
        ...
        private bool CreateFilter(ref Fask.Interfaces.Filtry.VazbyMaterialyFiltr filtr)
        {
            ...
            filtr.MaterialLocncode = comboBox_AddMaterial_LOCNCODE.Text.Trim();
            filtr.MaterialSklID = comboBox_AddMaterial_SKL_ID.Text.Trim();
            filtr.MaterialITEMDESC = comboBox_AddMaterial_ITEMDESC.Text.Trim();
            filtr.MaterialVNDITNUM = comboBox_AddMaterial_VNDITNUM.Text.Trim();
            filtr.MaterialCarKod = comboBox_AddMaterial_CZ_CarKod.Text.Trim();
        ...
        private void PerformVyhledat()
        {
            try
            {
                DataTable dtchanged = this.dsProduct.FASK_ZASOBY_KONZOLA.GetChanges();
        ...
        private void bw_MaterialyAdd_stav_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                ...
                {
                    // handle the error
                    dsProduct = new Fask.Interfaces.DataSets.Zbozi();
                ...
                else
                {
                    ...
                    dsProduct = (Fask.Interfaces.DataSets.Zbozi)e.Result;
                    if (dsProduct == null)
                        dsProduct = new Fask.Interfaces.DataSets.Zbozi();
        ...
        private void PerformVycistitFiltr_P()
        {
            try
            {
                ...
                comboBox_P_Material_ITEMDESC.SelectedItem = null;
