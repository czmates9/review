...
{
    public partial class FormOdvod_EventsErrList : Form
    {
        ...
        public Fask.Interfaces.DataSets.Vyroba.FASK_EventsErrRow FASK_EventsErr_selectedRow
        {
            get
            {
                try
                {
                    return ((DataRowView)(dg_OdvodEvents.BindingContext[bs_OdvodEventsErr].Current)).Row as Fask.Interfaces.DataSets.Vyroba.FASK_EventsErrRow;
                }
                catch
                {
                    return null;
        ...
        private List<Fask.Interfaces.DataSets.Vyroba.FASK_EventsErrRow> FASK_EventsErr_selectedRows
        {
            //get
            //{
            //    List<Fask.Interfaces.DataSets.Vyroba.FASK_EventsErrRow> rows = new List<Fask.Interfaces.DataSets.Vyroba.FASK_EventsErrRow>();

            //    foreach (DataGridViewRow selectedRow in dg_OdvodEvents.SelectedRows)
            //    {
            //        Fask.Interfaces.DataSets.Vyroba.FASK_EventsErrRow row = ((DataRowView)selectedRow.DataBoundItem).Row as Fask.Interfaces.DataSets.Vyroba.FASK_EventsErrRow;
            //        rows.Add(row);
            //    }
            ...
            get
            {
                return dg_OdvodEvents.SelectedRows
                    ...
                    .Select(r => ((DataRowView)r.DataBoundItem).Row as Fask.Interfaces.DataSets.Vyroba.FASK_EventsErrRow)
                    .Where(r => r != null)
                    .ToList();
            }
        }
        ...
        /// </summary>
        private List<Fask.Interfaces.Filtry.Odvod_EventsErrListFiltr> filtry = new List<Fask.Interfaces.Filtry.Odvod_EventsErrListFiltr>();

        /// <summary>
        /// Vybrany filtr.
        /// </summary>
        private Fask.Interfaces.Filtry.Odvod_EventsErrListFiltr rowFiltr
        {
            get
            {
                try
                {
                    return tscbFiltry.SelectedItem as Fask.Interfaces.Filtry.Odvod_EventsErrListFiltr;
                }
                catch
                {
                    return null;
        ...
        public FormOdvod_EventsErrList() 
        {
            InitializeComponent();
        ...
        public FormOdvod_EventsErrList(bool allowMultiSelect, Fask.Interfaces.Classes.ZOBRAZENI_TYP typZobrazeni) : this()
        {
        ...
        private void FormOdvod_EventsErrList_Load(object sender, EventArgs e)
        {
            try
            {
                this.ShowIcon = false;
                ...
                this.filtry = Extensions.ListExt.ReadFromXML<Fask.Interfaces.Filtry.Odvod_EventsErrListFiltr>(this.GetType().ToString() + ".filtr");
        ...
        private void FormOdvod_EventsErrList_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FormOdvod_EventsErrList_Shown(object sender, EventArgs e)
        {
            try
            {
        ...
        public virtual void WaithToEndThread()
        {
            ...
            try
            {
                if (bw_OdvodEventsErr.IsBusy)
                {
                    bw_OdvodEventsErr.CancelAsync();
                    while (bw_OdvodEventsErr.IsBusy)
                    {
        ...
        public  void PerformVyhledat() {
            ...
            try
            {
                DataTable dtchanged = this.ds_OdvodEventsErr.FASK_EventsErr.GetChanges();
                ...
                Fask.Interfaces.Filtry.Odvod_EventsErrListFiltr filtr = new Fask.Interfaces.Filtry.Odvod_EventsErrListFiltr();
                ...
                bw_OdvodEventsErr.RunWorkerAsync(filtr);
        ...
        public void PerformZmenitFiltr() 
        {
            try
            {
                ...
                Fask.Interfaces.Filtry.Odvod_EventsErrListFiltr filtr = rowFiltr;
        ...
        /// Nastavit Filter
        /// </summary>
        public void PerformNastavitFiltr(Fask.Interfaces.Filtry.Odvod_EventsErrListFiltr filtr) 
        {
            try
            {
                if (filtr == null)
        ...
        /// <returns></returns>
        private bool CreateFilter(ref Fask.Interfaces.Filtry.Odvod_EventsErrListFiltr filtr)
        {
            if (filtr == null)
                filtr = new Fask.Interfaces.Filtry.Odvod_EventsErrListFiltr();
        ...
        private void bw_OdvodEvents_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                Fask.Interfaces.Filtry.Odvod_EventsErrListFiltr filtr = (Fask.Interfaces.Filtry.Odvod_EventsErrListFiltr)e.Argument;
                Fask.Interfaces.DataSets.Vyroba ds = new Fask.Interfaces.DataSets.Vyroba();

                if (bw_OdvodEventsErr.CancellationPending)
                {
                    e.Cancel = true;
                    return;
                }
                ...
                {
                    throw new NotImplementedException("Provider neobsahuje implemetaci IOdvod_EventsErr_GetFiltrovanyOdvodEvents");
                }
        ...
        private void bw_OdvodEvents_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                ...
                {
                    // handle the error
                    ds_OdvodEventsErr = new Fask.Interfaces.DataSets.Vyroba();
                    bs_OdvodEventsErr.DataSource = ds_OdvodEventsErr;
                ...
                else
                {
                    ...
                    ds_OdvodEventsErr = (Fask.Interfaces.DataSets.Vyroba)e.Result;
                    if (ds_OdvodEventsErr == null)
                        ds_OdvodEventsErr = new Fask.Interfaces.DataSets.Vyroba();

                    bs_OdvodEventsErr.DataSource = ds_OdvodEventsErr;

                    if (ds_OdvodEventsErr.FASK_EventsErr.Count == 0)
                        SetStatusLabelText_Events(-1);
                    else
                    {
        ...
        private void SetStatusLabelText_Events(int index)
        {
            ...
            tssl_Eventu_Count.Text = string.Format("{0}/{1}", index + 1, ds_OdvodEventsErr.FASK_EventsErr.Count);
        }
        ...
        private void Perform_Tisk_Selected_Primy_Tisk(string klicTyp, string NazevVychoziTiskarny, string pocetVytisku)
        {
            try
            {
                ...
                if (FASK_EventsErr_selectedRow == null)
                {
                ...
                foreach (var item in FASK_EventsErr_selectedRows)
                {

                    if (Konfigurace.Globals_Konfig_Konzola.Konfigurace.System[0].Log_Tisky_hl)
                    {
                        Fask.Logging.ExceptionHandler2.Handle(LogLevel.PrintInfo, "---------------------------------------Start vyroba/rozbory/prehled_odvadeni_stroju_chyby TISK zpl zaznam: " + index_zaznamu.ToString() + "-------------------------------------");
                        ...
                        Fask.Logging.ExceptionHandler2.Handle(LogLevel.PrintInfo, "---------------------------------------END vyroba/rozbory/prehled_odvadeni_stroju_chyby TISK zpl zaznam: " + index_zaznamu.ToString() + "-------------------------------------");
                ...
                else
                {
                    ...
                    Tisk_selected_rows_Primy_Tisk(plr_Path, true, MN_ToTisk, FASK_EventsErr_selectedRows, NazevVychoziTiskarny);
        ...
        private void Tisk_selected_rows_Primy_Tisk(string plr_Path, bool MnozstvuAutoJedna, int MN_ToTisk, List<Fask.Interfaces.DataSets.Vyroba.FASK_EventsErrRow> FASK_EventsErr_selected_Rows, string nazevVychTiskarny)
        {
            try
            {
                ...
                foreach (var item in FASK_EventsErr_selected_Rows)
                {
        ...
        private void PerformPrint(bool primyTisk, string klicTyp, string nazevVychTiskarny, string pocetVytisku)
        {
            try
            {
                ...
                foreach (Fask.Interfaces.DataSets.Vyroba.FASK_EventsErrRow row in FASK_EventsErr_selectedRows)
                {
                    try
                    {
                        Fask.Interfaces.DataSets.Vyroba.FASK_EventsErrRow newRow = dt.NewFASK_EventsErrRow();
                        ...
                        dt.AddFASK_EventsErrRow(newRow);
                    }
                    catch (Exception ex)
                    {
                        // Ošetření vyjimky
                ...
                //foreach (Fask.Interfaces.DataSets.Vyroba.FASK_EventsErrRow row in dt)
                //{
        ...
        private void PrintReport_RDLC(Fask.Interfaces.DataSets.Vyroba.FASK_EventsErrDataTable dt, bool primyTisk, string path_sablona, string nazevVychTiskarny, int pocetVytisku)
        {
            try
            {
                ...
                if (Konfigurace.Globals_Konfig_Konzola.Konfigurace.System[0].Log_Tisky_hl)
                {
                    ...
                    {
                        Fask.Logging.ExceptionHandler2.Handle(LogLevel.PrintInfo, "---------------------------------------Start vyroba/rozbory/prehled_odvadeni_stroju_chyby TISK rdlc-------------------------------------");
                        ...
                        Fask.Logging.ExceptionHandler2.Handle(LogLevel.PrintInfo, "---------------------------------------END vyroba/rozbory/prehled_odvadeni_stroju_chyby TISK rdlc-------------------------------------");
                    }
                }
        ...
        private void Perform_Tisk_Selected(string klicTyp, string NazevVychoziTiskarny, string pocetVytisku)
        {
            try
            {
                ...
                else
                {
                    ...
                    Tisk_selected_rows(plr_Path, true, MN_ToTisk, FASK_EventsErr_selectedRows);
        ...
        private void Tisk_selected_rows(string plr_Path, bool MnozstvuAutoJedna, int MN_ToTisk, List<Fask.Interfaces.DataSets.Vyroba.FASK_EventsErrRow> FASK_EventsErr_selected_Rows)
        {
            try
            {
        ...
        private string PrepareDataToTisk(
            string strPath,
            Fask.Interfaces.DataSets.Vyroba.FASK_EventsErrRow row,
            int? mnozstviDoTisku
            )
        {
            try
        ...
        private Dictionary<string, string> PrepareDataToTisk(Fask.Interfaces.DataSets.Vyroba.FASK_EventsErrRow FASK_EventsErrRow_data)
        {
            try
            {
                while (true)
                {
                    try
                    {
                        ...
                        {
                            string key = dcol.ColumnName;
                            string value = FASK_EventsErrRow_data[dcol.ColumnName].ToString();
