...
{
    public partial class Form_DateTime_From_To : Form
    {
        public string Popis
        {
            set { this.Text = value; }
        ...
        public string Material
        {
            get
            {
                //if (cb_Mat.SelectedItem != null)
                //    return cb_Mat.SelectedItem.ToString();
                //else
                    return cb_Mat.Text;
            }
        }

        public DataTable DataTableMaterialy { get; set; }

        public Form_DateTime_From_To()
        {
            InitializeComponent();
        ...
        private void Form_DateTime_From_To_Load(object sender, EventArgs e)
        {
            ...
            if ((DataTableMaterialy != null) && (DataTableMaterialy.Rows.Count > 0))
            {
                foreach (DataRow item in DataTableMaterialy.Rows)
                {
                   cb_Mat.Items.Add(item["material"].ToString());
                }
            }
