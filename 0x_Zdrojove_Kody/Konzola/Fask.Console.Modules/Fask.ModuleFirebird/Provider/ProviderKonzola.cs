...

    {
        ...
        public Console.Interfaces.DataSets.Konzola.FASK_LoginsRow GetUzivatel(string userid)
        {
            ...
            try
            {
                ...
                command = new FirebirdSql.Data.FirebirdClient.FbCommand();
        ...
        {
            FirebirdSql.Data.FirebirdClient.FbTransaction trans = null;
            FirebirdSql.Data.FirebirdClient.FbConnection connection = null;
            FirebirdSql.Data.FirebirdClient.FbCommand command = null;
            FirebirdSql.Data.FirebirdClient.FbCommand command2 = null;
            ...
            try
            {
                ...
                command = new FirebirdSql.Data.FirebirdClient.FbCommand(insertCmd, connection, trans);
                ...
                command2 = new FirebirdSql.Data.FirebirdClient.FbCommand(insertAuth, connection, trans);
        ...
        public bool DeleteUzivatelAOpravneni(string id)
        {
            ...
            try
            {
                ...
                command = new FirebirdSql.Data.FirebirdClient.FbCommand(deleteCmd, connection, trans);
                command.Parameters.AddWithValue("@id", id);

                command.ExecuteNonQuery();

                string deleteAuth = "delete from " + Fask.Console.Interfaces.Constants.Tables.TABLE_FASK_LOGINS_AUTH + " where id=@id";
                command2 = new FirebirdSql.Data.FirebirdClient.FbCommand(deleteAuth, connection, trans);
