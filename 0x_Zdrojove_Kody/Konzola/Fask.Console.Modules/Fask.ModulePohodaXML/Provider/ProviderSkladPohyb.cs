        ...
        Fask.Interfaces.SkladPohyb.ISkladPohyb2_GetTypPohybu
    {
        ...
        public Fask.Interfaces.DataSets.SkladPohyb GetFiltrovanySkladLokace(Fask.Interfaces.Filtry.SkladPohybListFiltr filtr, string tableName)
        {
            ...
            try
            {
                ...
                //command.CommandText += "left join " + Fask.SQL.Constants.Common.TABLE_CZMST_SKLADLOKACE_STAV + " SLS on SLS.SERLTNUM = pohyb.SERLTNUM AND SLS.SKL_ID = pohyb.SKL_ID and sls.ITEMNMBR=pohyb.ITEMNMBR and pohyb.LOCNCODE=SLS.LOCNCODE ";
                ...
                if (!string.IsNullOrEmpty(filtr.rowUzivatel.Trim()) || !string.IsNullOrEmpty(filtr.UzivatelID.Trim()))
                {
                    ...
                    "SELECT distinct USERID FROM " + Fask.SQL.Constants.Common.TABLE_FASK_LOGINS + " where USERID=@user " +
                    ") ";
                ...
                ////19.11.2025 MaR zakomentovano a nahrazeno
