...
namespace Fask.ModulePohodaXML.Provider
{
    public partial class Provider :
        Fask.Console.Interfaces.Vyroba.ProductionSources.IProductionSources,
        Fask.Console.Interfaces.Vyroba.ProductionSources.IProductionSources_GetFiltrovanyProductionSourcesList,
        Fask.Console.Interfaces.Vyroba.ProductionSources.IProductionSources_ImportVydejkaPohoda,
        Fask.Console.Interfaces.Vyroba.ProductionSources.IProductionSources_GetDataSelectListImport
    {
        ...
        public Fask.Console.Interfaces.DataSets.Vyroba GetFiltrovanyProductionSourcesList(Console.Interfaces.Classes.ProductionSourcesListFiltr filtr)
        {
        ...
        Fask.Console.Interfaces.DataSets.Vyroba Console.Interfaces.Vyroba.ProductionSources.IProductionSources_GetDataSelectListImport.GetDataSelectListImport()
        {
