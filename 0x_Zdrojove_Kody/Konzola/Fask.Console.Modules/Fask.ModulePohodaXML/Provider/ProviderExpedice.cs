        ...
        Fask.Interfaces.Expedice.IExpedice2_GetBufferPolozky
    {
        ...
        public Fask.Interfaces.DataSets.Expedice GetFiltrovaneExpedicePolozky(Fask.Interfaces.Filtry.ExpediceFormDodaciListyListFiltr filtr)
        {
            ...
            try
            {
                ...
                command.CommandText =
                    "select polozky.*, hlavicka.PrepravceID, hlavicka.PrepravceSPZ, hlavicka.Rozpracovano, uzivatel.USERID as UserLogin, uzivatel.FIRSTNAME as UserFIRSTNAME, uzivatel.surname as UserSECONDNAME, hlavicka.TermID as TermID, hlavicka.UserID as UserID, hlavicka.DateFinished as HlavickaDateFinished, hlavicka.DateCreated as HlavickaDateCreated from " + Fask.SQL.Constants.Common.TABLE_CZMST_EXPEDICE_POLOZKY + " polozky " +
        ...
        public Fask.Interfaces.DataSets.Expedice GetBufferPolozky()
        {
            ...
            try
            {
                ...
                //   ;
                  ...
                  command.CommandText =  "select ITEMNMBR, ITEMDESC, QTYSHPPD, SERLTNUM, NMBRBAL,VNDITNUM, CZ_CarKod, DEX_ROW_ID, GUID, null as NMBRPAL from CZMST_Expedice_Baleni_Buffer "
                 + "union "
                 + "select ITEMNMBR, ITEMDESC, QTY as QTYSHPPD, SERLTNUM, NMBRBAL, VNDITNUM, CZ_CarKod, DEX_ROW_ID, IDPol as GUID, NMBRPAL as NMBRPAL from CZMST_Expedice_Baleni_Polozky "
                 //+ "where " +
                 //  "1=1 "
                   ;
