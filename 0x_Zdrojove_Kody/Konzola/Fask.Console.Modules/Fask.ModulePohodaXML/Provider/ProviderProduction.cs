...
namespace Fask.ModulePohodaXML.Provider
{
    public partial class Provider : 
        Fask.Console.Interfaces.Vyroba.IProduction,
        Fask.Console.Interfaces.Vyroba.IProduction_GetFiltrovanyProductionList,
        Fask.Console.Interfaces.Vyroba.IProduction_ImportPrijemkaPohoda,
        Fask.Console.Interfaces.Vyroba.IProduction_GetDataSelectListImport

    {
        ...
        public Production.DataServices.VyrobaDataSet GetFiltrovanyProductionList(Console.Interfaces.Classes.ProductionListFiltr filtr)
        {
        ...
        public string ImportPrijemkaPohoda(int countEntries,string SKL_ID, Fask.Console.Interfaces.DataSets.Konzola.FASK_CONS_LoginsRow userID)
        {
            ...
            try{
                ...
                if (!Prijem.CreateRequest_Import_Prijemka_XML(dt_p, filename, countEntries, SKL_ID, ""))
                    return "CHYBA";
                ...
                if (Prijem.LoadResponse_Import_Prijemka_XML(dt_p, respfilename, countEntries, SKL_ID))
                {
        ...
        public string LoadPrijemImportResponseXMLAndMakeUpdateDB(string file, int countentries)
        {
            ...
            try
            {
                ...
                prod_Adapter.Connection.ConnectionString = Globals.ConnectionString;
                ...
                foreach (Pohoda_DataSets.Prijem.ProductionRow pir in prijemDS.Production)
                {
                    ...
                    { //nic se nedeje, protoze nebyly nalezeny => log... jde o chybu ...
                        Logging.Log.Write("Parovani nenalezlo volnou shodu v databazi skpppol s polozkou:" + pir.ORD + "|" + pir.ITEMNMBR + "|" + pir.qty + "|" + pir.GUID.ToString(), "PrijemPohodaXML" + "," + "LoadPrijemImportResponseXmlAndMakeUpdateDB");
        ...
        public Production.DataServices.VyrobaDataSet GetDataSelectListImport()
        {
