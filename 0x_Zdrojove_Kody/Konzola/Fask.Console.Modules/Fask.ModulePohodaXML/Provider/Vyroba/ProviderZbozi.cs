        ...
        Fask.Console.Interfaces.Vyroba.Zbozi.IZboziVyroba_ExportFaskCons095
    {
        ...
        public string ExportFaskCons095()
        {
            ...
            try
            {
                ...
                Pohoda_DataSets.DatabasePohoda.SKzDataTable skzDataTable = new Pohoda_DataSets.DatabasePohoda.SKzDataTable();
                Pohoda_DataSets.DatabasePohoda.SKzAlternativesDataTable skzalternativesDT = new Pohoda_DataSets.DatabasePohoda.SKzAlternativesDataTable();
                Pohoda_DataSets.DatabasePohoda.SKzParametryDataTable skzparametryDT = new Pohoda_DataSets.DatabasePohoda.SKzParametryDataTable();
                ...
                CZMST_095TableAdapter.Connection = new SqlConnection(Globals.ConnectionString);
                ...
                int ITEMDES_MaxLength = (int)Fask.Columns.Inicializace.InitInstance.Vyroba.ColumnsInfo_FASK_CONS_095["ITEMDESC"].MaxLength;
                int ODB_ID_MaxLength = (int)Fask.Columns.Inicializace.InitInstance.Vyroba.ColumnsInfo_FASK_CONS_095["ODB_ID"].MaxLength;
                int LOCNCODE_MaxLength = (int)Fask.Columns.Inicializace.InitInstance.Vyroba.ColumnsInfo_FASK_CONS_095["LOCNCODE"].MaxLength;
                int VNDITNUM_MaxLength = (int)Fask.Columns.Inicializace.InitInstance.Vyroba.ColumnsInfo_FASK_CONS_095["VNDITNUM"].MaxLength;
                int CZ_CarKod_MaxLength = (int)Fask.Columns.Inicializace.InitInstance.Vyroba.ColumnsInfo_FASK_CONS_095["CZ_CarKod"].MaxLength;
                int MJ_MaxLength = (int)Fask.Columns.Inicializace.InitInstance.Vyroba.ColumnsInfo_FASK_CONS_095["MJ"].MaxLength;
                int ITEMNMBR_MaxLength = (int)Fask.Columns.Inicializace.InitInstance.Vyroba.ColumnsInfo_FASK_CONS_095["ITEMNMBR"].MaxLength;
