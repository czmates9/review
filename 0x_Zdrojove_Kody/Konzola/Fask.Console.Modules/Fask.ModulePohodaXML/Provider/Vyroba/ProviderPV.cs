...
//order by DEX_ROW_ID
        ...
        public Fask.Interfaces.DataSets.Vyroba_Planovani GetZaplanovani_old_20251125(Fask.Interfaces.Filtry.Vyroba_PV_Zap_Filtr filter)
        {
        ...
        public Fask.Interfaces.DataSets.Vyroba_Planovani GetZaplanovani(Fask.Interfaces.Filtry.Vyroba_PV_Zap_Filtr filter)
        {
            ...
            try
            {
                using (var conn = new System.Data.SqlClient.SqlConnection(Globals_V1.Konfigurace.ConnectionStrings[0].FASKDB))
                using (var da = new System.Data.SqlClient.SqlDataAdapter("dbo.FASK_proc_EXPORT_POHODA_FASK_NacteniOPlanu", conn))
                {
                    da.SelectCommand.CommandType = System.Data.CommandType.StoredProcedure;

                    // Název Pohoda DB jako vstupní parametr
                    string pohodaDbName = Globals_V1.Konfigurace.PohodaInfo[0].DB_Name_pohoda;
                    da.SelectCommand.Parameters.AddWithValue("@PohodaDBName", pohodaDbName);

                    // Bool
                    da.SelectCommand.Parameters.AddWithValue("@Nezaplanovane", filter.Nezaplanovane);
                    da.SelectCommand.Parameters.AddWithValue("@PohodaE1", Globals_V1.Konfigurace.PohodaInfo[0].POHODA_E1);
                    ...
                    object ObjOrNull(string s) =>
                        string.IsNullOrWhiteSpace(s) ? (object)DBNull.Value : s;

                    // Textové filtry
                    da.SelectCommand.Parameters.AddWithValue("@OBJ", ObjOrNull(filter.OBJ));
                    da.SelectCommand.Parameters.AddWithValue("@Kod", ObjOrNull(filter.Kod));
                    da.SelectCommand.Parameters.AddWithValue("@Firma", ObjOrNull(filter.Firma));
                    da.SelectCommand.Parameters.AddWithValue("@FormaUhrady", ObjOrNull(filter.FormaUhrady));

                    // UserParam_1–5
                    da.SelectCommand.Parameters.AddWithValue("@UserParam_1", ObjOrNull(filter.UserParam_1));
                    da.SelectCommand.Parameters.AddWithValue("@UserParam_2", ObjOrNull(filter.UserParam_2));
                    da.SelectCommand.Parameters.AddWithValue("@UserParam_3", ObjOrNull(filter.UserParam_3));
                    da.SelectCommand.Parameters.AddWithValue("@UserParam_4", ObjOrNull(filter.UserParam_4));
                    da.SelectCommand.Parameters.AddWithValue("@UserParam_5", ObjOrNull(filter.UserParam_5));
            ...
            catch (Exception ex)
            {
                ...
                // radši vrať prázdný dataset, ne null
                return null;
            }
        ...
        private string ExportKatalogPV_Procedura()
        {
            ...
            try
            {
                ...
                System.Data.SqlClient.SqlCommand adpacommand = new System.Data.SqlClient.SqlCommand("FASK_proc_EXPORT_POHODA_FASK_PlanovaniVyroby");
