...
namespace Fask.Console.Interfaces.Classes
{
    ...
    public class StavSkladuHistorieFiltr
    {
        ...
        public Fask.Console.Interfaces.DataSets.StavSkladu.CZMSTPWDRow rowUzivatel { get; set; }
        ...
        // vybrany zaznam z comboboxu nebo vyplneny popis
        public Fask.Console.Interfaces.DataSets.StavSkladu.get_os_msRow rowMaterialLOCNCODESRC { get; set; }
        public string MaterialLocncodeSRC { get; set; }

        // vybrany zaznam z comboboxu nebo vyplneny popis
        public Fask.Console.Interfaces.DataSets.StavSkladu.get_os_msRow rowMaterialLOCNCODEDST { get; set; }
        public string MaterialLocncodeDST { get; set; }

        // vybrany zaznam z comboboxu nebo vyplneny popis zdrojoveho skladu
        public Fask.Console.Interfaces.DataSets.StavSkladu.CZMST093Row rowMaterialSKLIDSRC { get; set; }
        ...
        // vybrany zaznam z comboboxu nebo vyplneny popis zdrojoveho skladu
        public Fask.Console.Interfaces.DataSets.StavSkladu.CZMST093Row rowMaterialSKLIDDST { get; set; }
