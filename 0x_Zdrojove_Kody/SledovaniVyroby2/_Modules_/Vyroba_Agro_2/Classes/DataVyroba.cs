...
namespace FASK.SledovaniVyroby.Module.Vyroba_Agro.Classes
{
    public class DataVyroba
    {
        ...
        private bool prohaz_Spatny_Kod = false;
        private string prohaz_Kod_Polozky = string.Empty;
        ...
        public string GetStateInternal()
        {
            try
            {
                ...
                //TODO MaR 3.7.2023 pridan novy radek
                sb.AppendLine("_odvodVyroby._codeProhazCount=" + this._odvodVyroby._codeProhazCount);
        ...
        public enum VyrobaStavy { 
            ...
            , SERVIS = 25
            , VPP_VlozitKod_Prohaz =26
            , VPP_VlozitKod_Prohaz_Opakuj = 27
        };
        #endregion
        ...
        /// </summary>
        private DataSets.Pytel _pytle = new Vyroba_Agro.DataSets.Pytel();
        /// <summary>
                ...
                if (novyStav == this.StavVyroba) // nastaveni na novy stav dojde jen pokud se neco meni ...
                {
                    switch (this.StavVyroba)
                    {
                        ...
                        case VyrobaStavy.SERVIS:
                            ...
                            break;
                        case VyrobaStavy.VPP_VlozitKod_Prohaz:
                            this.StavVyroba_VPP_VlozitKod_Prohaz(null);
                            break;
                        case VyrobaStavy.VPP_VlozitKod_Prohaz_Opakuj:
                            this.StavVyroba_VPP_VlozitKod_Prohaz_Opakuj(null);
                            break;
                        default:
                            //
                            break;
        ...
        private void StavVyroba_Main(Button btn)
        {
            ...
            else if (btn.Name == "btnF3") // zmena prohazovani
            {
                ...
                else
                {
                    ...
                    this.StavVyroba = (DataVyroba.VyrobaStavy.VPP_VlozitKod_Prohaz);
                }
            ...
            else if (btn.Name == "btnF1") // vloz kod
            {
                ...
                // 23.3.2023 Dle požadavku Jana Skřívánka podmínka byla zakomentována, ze slovy: "Však ten další pytel to spravý"
...
// MERGE - TaD 14.10.2022 
                        ...
                        ExceptionHandler2.Handle("Posledni paleta, DialogResult:" + res.ToString(), "Log_Vyroba_Agro_2", "txt");
        ...
        private void StavVyroba_ZmenaProhaz(Button btn)
        {
            ...
            else if (btn.Name == "BtnEnter")
            {
                ...
                else
                {
                    ...
                    //TODO MaR 26.6. 2023 ulozeni do lokalni databaze //zakomentovano
...
//#endif
                    ...
                    {// prohazovani
                        ...
                        //TODO MaR 26.6. 2023 pridani tagu zda je rezim prohazovani
                        ...
                        //this.VyrobaActualDataSaveAndResetActualBarcode(Constants.Common.STAV_zmenaProhazON, this._vyroba2_Scan.ReadBarcode);

                        _odvodVyroby.CodeProhazZapnutSpatnyKoD(prohaz_Spatny_Kod);

                        if (prohaz_Spatny_Kod)
                        {
                            this.VyrobaActualDataSaveAndResetActualBarcode(Constants.Common.STAV_zmenaProhazON, prohaz_Kod_Polozky, true);
                            this.VyrobaActualDataSaveAndResetActualBarcode(Constants.Common.STAV_zmenaProhazON_SpatnyKod, prohaz_Kod_Polozky, true);
                    ...
                    else
                    {
                        ...
                        if (prohaz_Spatny_Kod)
                        {
                            this.VyrobaActualDataSaveAndResetActualBarcode(Constants.Common.STAV_zmenaProhazOFF, prohaz_Kod_Polozky, true);
        ...
        /// </summary>
        /// <param name="btn"></param>
        private void StavVyroba_VPP_VlozitKod_Prohaz(Button btn)
        {
            this.NumKeyPressedCheck(btn);
            //prohaz_Kod_Polozky = string.Empty;
            prohaz_Spatny_Kod = false;


            if (btn == null)
            {
                Classes.Database_AGRO2.InsertNewUserEvents(this.SmenaID, AgroConfig.LOG_STAV_NASTAVEN, VyrobaStavy.VPP_VlozitKod_Prohaz_Opakuj.ToString(), "");

                // Information uc nastavit
                this.InformationUC.LblText = "Vložte kód položky z výrobního příkazu";
                this.InformationUC.TxtText = string.Empty;
                this.InformationUC.LblWarning = string.Empty;
                this.InformationUC.InfoIDCode = (int)VyrobaStavy.VPP_VlozitKod_Prohaz_Opakuj;
            ...
            if (btn.Name == "BtnEnter")
            {
                ...
                if (this._InformationUC.TxtText.Length <= 0)
                {
                    ...
                    this.StavVyroba = (DataVyroba.VyrobaStavy.VPP_VlozitKod_Prohaz_Opakuj);
                    return;
                }
                ...
                if (row == null)
                {
                    //this.InformationUC.LblText = "Kód neodpovídá výrobku, vložit znovu?";// "Vložte kód položky z výrobního příkazu";
                    //this.InformationUC.TxtText = string.Empty;
                    //this.InformationUC.LblWarning = "Položka nenalezena!";
                    //prohaz_Kod_Polozky = BarcodeP;
                    this.StavVyroba = (DataVyroba.VyrobaStavy.VPP_VlozitKod_Prohaz_Opakuj);
                }
                else
                {
                    PolozkaVyrPrikazuSet(row);
                    this._odvodVyroby.BarcodeActual = string.Empty;
                    this.StavVyroba = (DataVyroba.VyrobaStavy.ZmenaProhaz);
                }
            }
            else if (btn.Name == "btn19")
        ...
        /// </summary>
        /// <param name="btn"></param>
        private void StavVyroba_VPP_VlozitKod_Prohaz_Opakuj(Button btn)
        {
            this.NumKeyPressedCheck(btn);
            ...
            if (btn == null)
            {
                ...
                // Information uc nastavit
                this.InformationUC.LblText = "Kód neodpovídá výrobku, vložit znovu?";
                this.InformationUC.TxtText = string.Empty;
                this.InformationUC.LblWarning = string.Empty;
                this.InformationUC.InfoIDCode = (int)VyrobaStavy.VPP_VlozitKod_Prohaz_Opakuj;
            ...
            #region new
            if (btn.Name == "btnF3") //ANO
            {

                //  this.StavVyroba = (DataVyroba.VyrobaStavy.VPP_VlozitKod_Prohaz);
                this.StavVyrobaStackSet(DataVyroba.VyrobaStavy.Main);
                this.StavVyroba = (DataVyroba.VyrobaStavy.VPP_VlozitKod_Prohaz);


            }
            else if (btn.Name == "btnF2") //NE
            {
                prohaz_Spatny_Kod = true;
                this.StavVyroba = (DataVyroba.VyrobaStavy.ZmenaProhaz);
            }
            else if (btn.Name == "btnF1") //STORNO
            {
                this.StavVyroba = (DataVyroba.VyrobaStavy.Main);
            }
            #endregion
        ...
        private void StavVyroba_VPP_VlozitKod(Button btn)
        {
            ...
            if (btn.Name == "BtnEnter")
            {
                ...
                else
                {
                    ...
                    //MaR 16.2.2024 carovy kod scanner empty
                    //this._odvodVyroby.BarcodeActual = string.Empty;

                    this._odvodVyroby.BarcodeActual = BarcodeP.Trim();
                    this._vyroba2_Scan.ReadBarcode = string.Empty;
            ...
            try
            {
                ...
                switch (this.StavVyroba)
                {
                    ...
                    case VyrobaStavy.SERVIS:
                        ...
                        break;
                    case VyrobaStavy.VPP_VlozitKod_Prohaz:
                        this.StavVyroba_VPP_VlozitKod_Prohaz(btn);
                        break;
                    case VyrobaStavy.VPP_VlozitKod_Prohaz_Opakuj:
                        this.StavVyroba_VPP_VlozitKod_Prohaz_Opakuj(btn);
                        break;
                    default:
                        break;
                }
                ...
                if (AgroConfig.config.Agro_OdvadeniKontrola[0].Odvadeni_Kontrola_Pouzit && _vpp_row != null)
                {
                    ...
                    if (AgroConfig.config.Agro_OdvadeniKontrola[0].Odvadeni_Var_1_pocet == _FujToKod)
                    {
                        if (AgroConfig.config.Agro_OdvadeniKontrola[0].Odvadeni_Var_1_pouzit)
                        {
                            ...
                            ExceptionHandler2.Handle("Spatny Kod: Houkacka", "Log_Vyroba_Agro_2", "txt");
                            //HoukackaRizeni(HoukackaStav.ON);
                        }
                    }
                    else if (AgroConfig.config.Agro_OdvadeniKontrola[0].Odvadeni_Var_2_pocet == _FujToKod)
                    {
                        if (AgroConfig.config.Agro_OdvadeniKontrola[0].Odvadeni_Var_2_pouzit)
                        {
                            ...
                            ExceptionHandler2.Handle("Spatny Kod: houkacka + hlaska", "Log_Vyroba_Agro_2", "txt");
                            HoukackaRizeni(HoukackaStav.ON);
                            this.InformationUC.LblWarning = "Nasnímaný č. kód neodpovídá výř. příkazu!";
                        }
                    }
...
// MERGE - TaD 14.10.2022 
                            ...
                            ExceptionHandler2.Handle("Spatny Kod: houkacka + hlaska + stop linka", "Log_Vyroba_Agro_2", "txt");
...
// MERGE - TaD 14.10.2022 
        ...
        private void algoritmusOdvodVyroba_2()
        {
            ...
            if (_vyroba2_Scan.ReadResult == Code.Read)
            {
                ...
                {
                    if (StavVyroba != VyrobaStavy.Zombie)
                    {
            ...
            if (this._vyroba2_SensorPytel.Active)
            {
                if ((_aktualDataRow != null) && (String.IsNullOrEmpty(_aktualDataRow.barcodeReaded)))
                    _aktualDataRow.barcodeReaded = _odvodVyroby.BarcodeActual; // pokud neni nastaven carovy kod, tak se nastavi ...
                //_odvodVyroby.CodeNoReadCnt++; //TODO MaR 26.6.2013 pocitani poctu pytlu?
                if (this.ProhazZapnut)
                {
        ...
        {
            //TODO MaR 26.6.2023 obsluha ukladani dat do lokalni databaze, smerovani z jinych obsluznych metod
            try
            {
                lock (_VyrobaActualDataSaveAndResetActualBarcodeSynchronizationObject)
                {
                    ...
                    //TODO MaR 26.6. 2023 - ulozeni zaznamu do Fask_Events v lokalni databazi
                    //TODO MaR 26.6.2023 - nulovani poctu QTY a QTYREAL, ktere pocitaji pytle?
                    ...
                    if (!odvodVyrobyReset && description == Constants.Common.STAV_automatickeUlozeni)
                    {
                        ulozeni = Classes.Database_AGRO2.InsertNewEvents(
                                              ...
                                              _odvodVyroby.BarcodeActual,                             // BarcodeReaded 
                                               _odvodVyroby.CodeProhazON_SpatnyKod ? string.Empty : barcodeSended,                                           // BarcodeSended 
                                              ZbyvaPocet,                                             // Zakazka
            ...
            try
            {
                lock (_VyrobaActualDataSaveAndResetActualBarcodeSynchronizationObject)
                {
                    ...
                    Classes.Database_AGRO2.InsertNewEvents(
                        ...
                        ZbyvaPocet,                                             // Zakazka
                        //TODO MaR 3.72023 implemetace prohazovani, zakomentovano a vytvoren novy zapis
                        //this.ProhazZapnut.ToString(),                           // popis 
                        _odvodVyroby.CodeProhazON.ToString(),                   //popis
                        "",                                                     // reporttype 
                        "",                                                     // IDO
                        _cidla_vstupni[0].SensorsCnt.ToString(),                // "", // scan1 - prubezna hondota cidla 0
                        _cidla_vstupni[1].SensorsCnt.ToString(),                // "", // scan2 - prubezna hondota cidla 1
                        ...
                        //TODO MaR 3.72023 implemetace prohazovani, zakomentovano a vytvoren novy zapis
                        //"",                                                     // sensor 
                        _odvodVyroby.CodeProhazCnt.ToString(),                  //sensor
                        this._sarze,                                            // material
                        _vph_sopnumbe,                                          // VPH
                        _vpp_row == null ? -1 : _vpp_row.DEX_ROW_ID,            // VPP
                        _vpp_row == null ? string.Empty : _vpp_row.BarcodeP,    // EAN_IS
        ...
        public void VyrobaActualDataSaveAndResetActualBarcode(bool odvodVyrobyReset, string description, string barcodeSended, decimal qty, decimal qtyreal,int? status, int? PocetPalet = null, string PackType = "", string PP_Button = "-", int zadanyPocetPytlu = 0)
        {
            try
            {
                lock (_VyrobaActualDataSaveAndResetActualBarcodeSynchronizationObject)
                {
                    ...
                    //    sscc_local = _SSCC;
                    decimal prohazenychPytlu = _odvodVyroby.CodeProhazCntGet();
                    ...
                    Classes.Database_AGRO2.InsertNewEvents(
                        ...
                        _odvodVyroby.CodeProhazON_SpatnyKod ? string.Empty : barcodeSended,                                          // BarcodeSended 
                        pal,                                                    // Zakazka
                        //TODO MaR 3.7.2023 zakomentovano a nahrazeno novym zapisem 
                        //this.ProhazZapnut.ToString(),                           // popis 
                        ...
                        _cidla_vstupni[1].SensorsCnt.ToString(),                // "", // scan2 - prubezna hondota cidla 1
                        _cidla_vstupni[2].SensorsCnt.ToString(),                // "", // scan3 - prubezna hondota cidla 2
                        //TODO MaR 3.7. 2023 pridan pocet pytlu z prohazovani
                        //"",                                                     // sensor 
                        _odvodVyroby.CodeProhazCntGetAndReset().ToString(),     // sensor 
                        this._sarze,                                            // material
                        _vph_sopnumbe,                                          // VPH
            ...
            VyrPrikaz prikaz = null)
        {
            try
            {
                lock (_VyrobaActualDataSaveAndResetActualBarcodeSynchronizationObject)
                {
                    ...
                    string pom = _odvodVyroby.CodeProhazCntGet().ToString();
