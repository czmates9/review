...
namespace FASK.SledovaniVyroby.Module.Vyroba_Agro
{
    public partial class KeyboardUC : UserControl
    {
            ...
            try
            {
              ...
              //  this.btnF6.DataBindings.Clear();
                ...
                if (this._keyboardText != null)
                {
                    ...
                    //this.btnF6.DataBindings.Add("Text", this._keyboardText, "BtnF6", false, DataSourceUpdateMode.OnPropertyChanged);
                }
        ...
        public KeyboardUC()
        {
            ...
            this._KeyboardsTextStavy.Add(
                DataVyroba.VyrobaStavy.VPP_VlozitKod_Prohaz,
                new KeyboardText( "STORNO", null, null, null, null, "Smazat", "OK")
               // new KeyboardText(null, null, null, null, null, "STORNO", "Smazat", "OK")
                );

            this._KeyboardsTextStavy.Add(
               DataVyroba.VyrobaStavy.VPP_VlozitKod_Prohaz_Opakuj,
                new KeyboardText( "STORNO", "NE", "ANO", null, null, null, null)
                //new KeyboardText(null, null, null, null, null, "Smazat", "OK")
               //new KeyboardText(null, null, null, null, null, "STORNO", "NE", "ANO")
               );
