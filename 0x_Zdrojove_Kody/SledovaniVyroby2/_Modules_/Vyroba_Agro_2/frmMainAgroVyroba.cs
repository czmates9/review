    ...
    public partial class frmMainAgroVyroba : Form, IModuleConnector
    {
        ...
        public void ClosePorts()
        {
            try
            {
                ...
                ExceptionHandler2.Handle("Ukonceni modulu", "Log_Vyroba_Agro_2", "txt");
            }
            catch
            { }
        }
        ...
        public frmMainAgroVyroba()
        {
            try
            {
                ...
                ExceptionHandler2.Handle("Spusteni modulu", "Log_Vyroba_Agro_2", "txt");
        ...
        internal void operace_Zmena()
        {
            ...
            ExceptionHandler2.Handle("operace_Zmena() - Houkacka OFF", "Log_Vyroba_Agro_2", "txt");
        ...
        private void LoadConfiguration()
        {
            ...
            {
                AgroConfig.config.Agro.AddAgroRow(0, 1, "1", 60, "998", "192.168.1.3", 1025, "", 120, 350, 100, 5, 5, 2, 10, 4, 1,2, 2, 3, 100, false, false, string.Empty, string.Empty, false, 1, -1, 2, 1000);
        ...
        private void Adam_DataReady(FASK.SledovaniVyroby.Module.Vyroba_Agro.ADAM.ADAM_60XX.AdamEventHandlerArgs e)
        {
            try
            {
