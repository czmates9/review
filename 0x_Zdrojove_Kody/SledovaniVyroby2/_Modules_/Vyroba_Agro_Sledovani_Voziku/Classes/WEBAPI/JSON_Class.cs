...
namespace FASK.SledovaniVyroby.Module.Vyroba_Agro_Sledovani_Voziku.Classes.WEBAPI
{
    class JSON_Class
    {
        public static string Serialize_JSON(object o)
        {
            string txt = JsonConvert.SerializeObject(o, Formatting.Indented, new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
            return txt;
        }
