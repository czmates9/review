...
namespace FASK.SledovaniVyroby.Module.Vyroba_Agro_Sledovani_Voziku.UC
{
    public partial class UC_Vaha : UserControl
    {
        ...
        public string L_2_text
        {
            set
            {
                L_2_value.Text = value;

            }
            get
            {
                return L_2_value.Text;
            }
        }
        ...
        public string L_4_text
        {
            set
            {
                L_4_value.Text = value;

            }
            get
            {
                return L_4_value.Text;
            }
        }
        ...
        private bool _Vaha_2_Connected;
        public bool Vaha_2_Connected()
        {
                return _Vaha_2_Connected;
        ...
        public bool Vaha_2_value
        {
            get
            {
                if (_Vaha_2_Connected)
                {
                    return true;
                }
                else
        ...
        public UC_Vaha()
        {
            ...
            _Vaha_2_Connected = true;
            L_1_value.Text = "Váha 1: ";
            L_2_value.Text = "Váha 2: ";
            BT_1_value.Text = "ON";
            BT_2_value.Text = "ON";
            BT_3_value.Text = "OFF";
            BT_4_value.Text = "OFF";
        ...
        public void updateForm()
        {
            try
            {
                ...
                if (_Vaha_2_Connected)
                {
                    L_4_value.Text = "Připojena";
                    L_4_value.ForeColor = Color.Green;
                    BT_2_value.Enabled = false;
                    BT_4_value.Enabled = true;
                }
                else
                {
                    L_4_value.Text = "Odpojena";
                    L_4_value.ForeColor = Color.Red;
                    BT_2_value.Enabled = true;
                    BT_4_value.Enabled = false;
                }
        ...
        private void BT_2_value_Click(object sender, EventArgs e)
        {
            _Vaha_2_Connected = true;
            updateForm();
        }
        ...
        private void BT_4_value_Click(object sender, EventArgs e)
        {
            _Vaha_2_Connected = false;
            updateForm();
        }
    }
}
