...
namespace FASK.SledovaniVyroby.ModuleIfc
{
    public interface IModuleConnector
    {
        ...
        /// <summary>
        /// Vrati true pokud muzeme modul zobrazit, false pokud ne + v message bude nejaka zprava, proc
        /// nelze modul uzavrt
        /// </summary>
        /// <param name="message"></param>
        /// <returns></returns>
        bool IsReadyToShow(out string message);
