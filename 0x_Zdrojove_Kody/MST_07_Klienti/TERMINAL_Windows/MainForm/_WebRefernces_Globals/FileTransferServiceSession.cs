...
namespace FASK.MST_WINDOWS.Main._WebRefernces_Globals
{
    public class FileTransferServiceSession : FileTransferServices.FileTransfer //FileTransferService.FileTransfer
    {
