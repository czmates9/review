    ...
    public static class Email
    {
        ...
        static void smtp_SendCompleted(object sender, System.ComponentModel.AsyncCompletedEventArgs e)
        {
            ...
            {                
                if (e.Error != null)
                {
                    FASK.MST_WINDOWS.ErrorLog.Log.Write("smtp_SendComplete=>Error");
                    FASK.MST_WINDOWS.ErrorLog.Log.WriteException(e.Error);
                }

                if (e.Cancelled)
                {
                    FASK.MST_WINDOWS.ErrorLog.Log.Write("smtp_SendComplete=>Cancelled");
                    FASK.MST_WINDOWS.ErrorLog.Log.WriteException("MailMessage Send Canceled");
                }
                ...
                if (e.UserState != null)
                {
                    if (e.UserState is string)
                    {
                        ...
                        FASK.MST_WINDOWS.ErrorLog.Log.Write("Message sended: " + emlfolder);
        ...
        public static void SendEmailMessageAsynch()
        {
            ...
            {
                FASK.MST_WINDOWS.ErrorLog.Log.WriteException(e);
            }
