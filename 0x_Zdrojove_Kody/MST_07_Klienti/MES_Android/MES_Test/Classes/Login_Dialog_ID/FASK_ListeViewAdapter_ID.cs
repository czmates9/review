...
namespace MES_Android.Classes.Login_Dialog_ID
{
    ...
    //
    public class FASK_ListeViewAdapter_ID : BaseAdapter<IDLogins>
    {
        public List<IDLogins> mItems; // neco jak pole stringu ale je to list to znamena ze je moznost pridavat
        ...
        //     ctor pro adapter
        //
        public FASK_ListeViewAdapter_ID(Context context, int rowLayout, List<IDLogins> items)
        {
            mItems = items;
            mContext = context;
        ...
        //
        public override IDLogins this[int position]
        {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            TextView txtID = row.FindViewById<TextView>(Resource.Id.txt_Loginsrow_ID);
            txtID.Text = mItems[position].Login;
