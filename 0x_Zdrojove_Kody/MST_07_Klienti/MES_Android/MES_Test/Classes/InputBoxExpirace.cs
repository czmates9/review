...
namespace MES_Android.Classes
{
    class InputBoxExpirace
    {
        ...
        public static DialogResult Show(Prodej_SberDat _CurrentContext, string caption, string defaultvalue, out string value, bool enableScanner, Android.Text.InputTypes keyboardMode)
        {
            value = string.Empty;
