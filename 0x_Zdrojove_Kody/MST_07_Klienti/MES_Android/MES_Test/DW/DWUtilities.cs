...
namespace MES_Android
{
    static class DWUtilities
    {
        ...
        private const String PROFILE_NAME = "TaD";
        ...
        //Pokud se bude chtit pracovat s DataWedge, tak pro každou aktivitu kde se bude chtít použivat scanner, musí byt svuj vlatní profil podle stranek zebry
        //https://techdocs.zebra.com/datawedge/8-2/guide/samples/multiactivity1/
        ...
        public static void CreateDWProfile(Context context)
        {
            ...
            Bundle keyConfig = new Bundle();
            keyConfig.PutString("PACKAGE_NAME", context.PackageName);      //  Associate the profile with this app
            profileConfig.PutParcelableArray("APP_LIST", new Bundle[] { keyConfig });
            sendDataWedgeIntentWithExtra(context, ACTION_DATAWEDGE, EXTRA_SET_CONFIG, profileConfig);
        }
