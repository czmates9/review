...
{
    public class SejmiKodAsync
    {
        public static TaskCompletionSource<SejmiKodAsync_Result> tcs;
        ...
        public static Task<SejmiKodAsync_Result> Show(
            ...
            )
        {
            ...
            tcs = new TaskCompletionSource<SejmiKodAsync_Result>();
        ...
        private static void OnConfirmCallBackOK(object sender, DialogClickEventArgs e)
        {
            ...
            tcs.SetResult(new SejmiKodAsync_Result() { 
    ...
    public class SejmiKodAsync_Result
    {
