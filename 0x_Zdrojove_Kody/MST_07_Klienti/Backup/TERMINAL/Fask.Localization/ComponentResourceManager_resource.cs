...
{
    public class ComponentResourceManager_resource : System.Resources.ResourceManager
    {
        System.Resources.ResourceManager resman = null;
        ResourceSet rs = null;

        public void CreateResource(string baseName, string resourceDir, Type usingResourceSet)
        {
            resman = ComponentResourceManager_resource.CreateFileBasedResourceManager(baseName, resourceDir, null);
        }

        public ComponentResourceManager_resource(Type t, string resourceDir)
            : base(t)
        {
            CreateResource(t.FullName, resourceDir, null);
        }
        ...
        public virtual void ApplyResources(object value, string objectName, CultureInfo culture)
        {
            try
            {
                ...
                resources = new SortedList<string, object>();
                if (rs == null)
                    rs = resman.GetResourceSet(culture, false, false);
