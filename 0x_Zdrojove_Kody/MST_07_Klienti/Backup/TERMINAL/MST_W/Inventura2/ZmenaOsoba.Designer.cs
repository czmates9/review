namespace Fask.MST_W.Inventura2
{
    partial class ZmenaOsoba
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ZmenaOsoba));
			...
			// timerLoad
			// 
			this.timerLoad.Tick += new System.EventHandler(this.ZmenaOsoba_Shown);
			// 
			// panel1
			// 
			...
			// menuItemNajit
			// 
			this.menuItemNajit.Text = "F1 - Èár. kód (ID)";
			...
			// menuItem10
			// 
			this.menuItem10.Text = "Titul";
			this.menuItem10.Click += new System.EventHandler(this.menuItem10_Click);
			// 
			// menuItem9
			// 
			this.menuItem9.Text = "Jméno";
			this.menuItem9.Click += new System.EventHandler(this.menuItem9_Click);
			// 
			// menuItem15
			// 
			this.menuItem15.Text = "Pøíjmení";
			...
			// menuItem13
			// 
			this.menuItem13.Text = "Titul";
			this.menuItem13.Click += new System.EventHandler(this.menuItem13_Click);
			// 
			// menuItem16
			// 
			this.menuItem16.Text = "Jméno";
			this.menuItem16.Click += new System.EventHandler(this.menuItem16_Click);
			// 
			// menuItem17
			// 
			this.menuItem17.Text = "Pøíjmení";
			...
			// menuItem12
			// 
			this.menuItem12.Text = "Bez osoby";
			...
			this.Name = "ZmenaOsoba";
			this.Text = "Osoby";
			this.Deactivate += new System.EventHandler(this.ZmenaOsoba_Deactivate);
			this.Load += new System.EventHandler(this.ZmenaOsoba_Load);
			this.Activated += new System.EventHandler(this.ZmenaOsoba_Activated);
			this.Closing += new System.ComponentModel.CancelEventHandler(this.ZmenaOsoba_Closing);
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.ZmenaOsoba_KeyDown);
