...
namespace Fask.MST_W.FileTransfer
{
    public class Uploading
    {
		...
		//        Program.mstw.mbw.Zprava = "Úspěšně odesláno: " + Co.ToString() + "\nProbíhá zpracování...";
		//        //return responseData;
		//        return "OK";
		//    }
		//    catch (Exception ex)
		...
		//        {
		//            Logging.Log.Write(exFileStream);
		//        }
		...
		//        {
		//            Logging.Log.Write(exStreamReader);
		//        }
		...
		public static string SendFile_API(string filePath_Z_kama, string filePath_kam, Co Co)
		{

			try
			{
				Program.mstw.mbw.Zprava = "Odesílá se: " + Co.ToString();

				RestSharp.API.Communication_3_5 com = new RestSharp.API.Communication_3_5(
					MST_Global.Adresa_API,
					MST_Global.Autorizace_API,
					MST_Global.API_konstant,
					MST_Global.isHTTPS,
					MST_Global.ServiceTimeOut,
					MST_Global.TerminalID.ToString(),
					"MST_W"
					);
