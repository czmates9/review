...
{
    partial class SejmiKodInfoForm3
    {
        /// <summary>
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SejmiKodInfoForm3));
			...
			this.btnZobrazitAlternativy.FocusMargin = 2;
			...
			this.panel1.Controls.Add(this.Note_l);
			this.panel1.Controls.Add(this.SERLTNUM_l);
			...
			this.Name = "SejmiKodInfoForm3";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.SejmiKodInfoForm3_KeyDown);
			this.Load += new System.EventHandler(this.SejmiKodInfoForm3_Load);
