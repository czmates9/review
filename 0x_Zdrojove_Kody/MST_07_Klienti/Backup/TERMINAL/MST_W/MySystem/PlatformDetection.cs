...
namespace PlatformDetection
{
    ...
    internal partial class Platform
    {
        ...
        {
            return PInvoke.GetOemInfo().Contains(MicrosoftEmulatorOemValue);
        }
        public static bool IsSmartphone()
        {
            return PInvoke.GetPlatformType().Contains("SmartPhone");
        }
        public static bool IsPocketPC()
        {
            return PInvoke.GetPlatformType().Contains("PocketPC");
        }
        public static bool IsWinCE()
        {
            return PInvoke.GetPlatformType().Contains("WinCE");
        }
        public static bool IsCENET()
        {
            return PInvoke.GetPlatformType().Contains("CE.Net");
        }
    }
}