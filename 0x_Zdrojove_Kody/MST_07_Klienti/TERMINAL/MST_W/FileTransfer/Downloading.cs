        ...
        public static bool DownloadFileFromServer(string fileciselnik, bool silent, bool overwrite)
        {
            ...
            try
            {
                ...
                */
                ...
                string url = MST_Global.ServerAddressSqliteDBs + MST_Global.TerminalID.ToString() + @"/" + Path.GetFileName(fileciselnik);
                //string FilePath = Path.Combine(UploadPath, FileName);
                System.Net.WebRequest wr = System.Net.WebRequest.Create(url);
                wr.Proxy = System.Net.GlobalProxySelection.Select;
				wr.Timeout = MST_Global.ServiceTimeOut;
            ...
            catch (Exception ex)
            {
                ...
                if (!silent)
                {
                    ...
                    {
                        Logging.Log.Write(ex);
                        Logging.Log.Write(ex.InnerException);
