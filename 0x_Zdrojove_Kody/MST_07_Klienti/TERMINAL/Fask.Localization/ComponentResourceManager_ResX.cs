    ...
    namespace Fask.Localization
    {
        ...
        public class ComponentResourceManager_ResX : ResourceManager
        {
            ...
            private ResourceSet_Resx rs = null;

            public ComponentResourceManager_ResX()
                : base()
            {
            }

            public ComponentResourceManager_ResX(Type t)
                : base(t)
            {
            }
            ...
            private CultureInfo NeutralResourcesCulture
            {
                get
                {
                    if (this._neutralResourcesCulture == null && MainAssembly != null)
                    {
            ...
            {
                //ResourceSet rs = base.GetResourceSet(culture, createIfNotExists, tryParents);
                if (rs == null)
                    rs = new ResourceSet_Resx(filenames);
                return rs;
            }
        }
    }
