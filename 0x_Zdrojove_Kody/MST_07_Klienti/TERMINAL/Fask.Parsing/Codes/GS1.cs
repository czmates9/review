...
namespace Fask.Parsing.Codes
{
		...
		, Interfaces.ICodeInterniFiremni93
    {
        ...
        public GS1(List<string> codes)
            : base(codes)
        {
        }

        public static GS1 Parse(string data)
        {
            return Parse(new List<string>() { data });
        }

        public static GS1 Parse(List<string> list_dataFull)
        {
            try
            {
