...
namespace Fask.Upgrade
{
    ...
    public class Updater
    {
        ...
        public void CheckForVersion(Fask.Upgrade.DataSet.UpdateInfo ds)
        {
            try
            {
        ...
        public DialogResult CheckForNewVersion(Fask.Upgrade.DataSet.UpdateInfo.UpdateDataRow udr, Version ver)
        {
            try
            {
        ...
        /// <param name="ver">aktialni verze na ctecke</param>
        /// <returns></returns>
        protected DialogResult showUpdateDialog(Fask.Upgrade.DataSet.UpdateInfo.UpdateDataRow udr, Version ver)
        {
            try
            {
