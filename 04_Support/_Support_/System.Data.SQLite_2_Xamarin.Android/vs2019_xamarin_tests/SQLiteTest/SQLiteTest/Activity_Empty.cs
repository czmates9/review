...
{
    [Activity(Label = "SQLiteTest", MainLauncher = true)]
    public class Activity_Empty : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            Dexter.WithActivity(this)
                ...
                .WithListener(new CompositeMultiplePermissionsListener(new Com.Karumi.Dexter.Listener.Multi.BaseMultiplePermissionsListener()))
                .WithErrorListener(new Com.Karumi.Dexter.Listener.EmptyPermissionRequestErrorListener())
                .Check()
                ;
            ...
            // Testcases ... 
            this.scrollView = FindViewById<ScrollView>(Resource.Id.activity_empty_scrollview);
            this.linearLayout_main_empty = FindViewById<LinearLayout>(Resource.Id.activity_empty);
            tv_welcome = FindViewById<TextView>(Resource.Id.tv_welcome);
            tv_welcome.Click += test_click;

            var pathDir = System.IO.Path.Combine(Android.OS.Environment.GetExternalStoragePublicDirectory(Android.OS.Environment.DirectoryDocuments).AbsolutePath, "SQLiteTest");
            if (!System.IO.Directory.Exists(pathDir))
                System.IO.Directory.CreateDirectory(pathDir);

            fileName = System.IO.Path.Combine(pathDir, "test.db");
            ...
            catch (Exception ex)
            {
                var ab = new AlertDialog.Builder(this)
                    ...
                    .SetPositiveButton("Continue", new EventHandler<DialogClickEventArgs>(error_continue_click));
        ...
        private void test_click(object sender, EventArgs e)
        {
            ...
            try
            {
                this.linearLayout_main_empty.RemoveAllViews();
        ...
        /// <summary>
        /// only accepts continue click
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void error_continue_click(object sender, DialogClickEventArgs e)
        {
