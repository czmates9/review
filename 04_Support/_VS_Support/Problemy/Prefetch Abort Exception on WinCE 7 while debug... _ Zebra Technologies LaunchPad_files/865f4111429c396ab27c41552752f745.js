...
;
/**
 * @depends path=/plugins/event-type-plugin/resources/script/fullcalendar.js
 * @depends path=/plugins/event-type-plugin/resources/script/jquery-ui-1.8.23.custom.min.js
 */
jive.namespace('EventCalendarApp');
