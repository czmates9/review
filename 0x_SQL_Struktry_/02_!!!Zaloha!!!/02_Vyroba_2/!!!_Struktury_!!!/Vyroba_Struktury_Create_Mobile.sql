...
CREATE TABLE CZPRO_VPP (
	...
	ITEMMJ nvarchar (5) NULL, -- mìrná jednotka položky,
	...
	QTYPACKMJ nvarchar (5) NULL, --mìrná jednotka balení,
...
CREATE TABLE UserEvents(
	...
	REZ1 nvarchar (20) NULL, --Doplòující údaj události obsluhy (napø. è.výrobního pøíkazu)
	GUID uniqueidentifier not null, --jedinecna idetifikace zaznamu, slouzi pro update do db, v pripade vicenasobneho prenosu
